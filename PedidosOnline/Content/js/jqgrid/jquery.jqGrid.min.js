...
var c=a(e.bDiv).height();if(c){var d=a("table:first",e.bDiv),g,i;if(d[0].rows.length)try{i=(g=d[0].rows[1])?a(g).outerHeight()||e.prevRowHeight:e.prevRowHeight}catch(j){i=e.prevRowHeight}if(i){e.prevRowHeight=i;var k=b.rowNum;g=e.scrollTop=e.bDiv.scrollTop;var m=Math.round(d.position().top)-g,l=m+d.height();i*=k;var n,o,p;if(l<c&&0>=m&&(void 0===b.lastpage||parseInt((l+g+i-1)/i,10)<=b.lastpage))o=parseInt((c-l+i-1)/i,10),0<=l||2>o||!0===b.scroll?(n=Math.round((l+g)/i)+1,m=-1):m=1;0<m&&(n=parseInt(g/
...
a("<div class='ui-jqgrid-view'></div>"),k=a.jgrid.msie;c.p.direction=a.trim(c.p.direction.toLowerCase());-1==a.inArray(c.p.direction,["ltr","rtl"])&&(c.p.direction="ltr");i=c.p.direction;a(j).insertBefore(this);a(this).removeClass("scroll").appendTo(j);var l=a("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");a(l).attr({id:"gbox_"+this.id,dir:i}).insertBefore(j);a(j).attr("id","gview_"+this.id).appendTo(l);a("<div class='ui-widget-overlay jqgrid-overlay' id='lui_"+this.id+
"'></div>").insertBefore(j);a("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'>"+this.p.loadtext+"</div>").insertBefore(j);a(this).attr({cellspacing:"0",cellpadding:"0",border:"0",role:"grid","aria-multiselectable":!!this.p.multiselect,"aria-labelledby":"gbox_"+this.id});var n=function(a,c){a=parseInt(a,10);return isNaN(a)?c||0:a},o=function(b,d,f,g,i,j){var k=c.p.colModel[b],m=k.align,l='style="',n=k.classes,o=k.name,p=[];m&&(l=l+("text-align:"+m+";"));k.hidden===true&&
(l=l+"display:none;");if(d===0)l=l+("width: "+e.headers[b].width+"px;");else if(k.cellattr&&a.isFunction(k.cellattr))if((b=k.cellattr.call(c,i,f,g,k,j))&&typeof b==="string"){b=b.replace(/style/i,"style").replace(/title/i,"title");if(b.indexOf("title")>-1)k.title=false;b.indexOf("class")>-1&&(n=void 0);p=b.split("style");if(p.length===2){p[1]=a.trim(p[1].replace("=",""));if(p[1].indexOf("'")===0||p[1].indexOf('"')===0)p[1]=p[1].substring(1);l=l+p[1].replace(/'/gi,'"')}else l=l+'"'}if(!p.length){p[0]=
"";l=l+'"'}l=l+((n!==void 0?' class="'+n+'"':"")+(k.title&&f?' title="'+a.jgrid.stripHtml(f)+'"':""));l=l+(' aria-describedby="'+c.p.id+"_"+o+'"');return l+p[0]},m=function(b){return b==null||b===""?"&#160;":c.p.autoencode?a.jgrid.htmlEncode(b):""+b},q=function(b,d,e,f,g){var h=c.p.colModel[e];if(h.formatter!==void 0){b=""+c.p.idPrefix!==""?a.jgrid.stripPref(c.p.idPrefix,b):b;b={rowId:b,colModel:h,gid:c.p.id,pos:e};d=a.isFunction(h.formatter)?h.formatter.call(c,d,b,f,g):a.fmatter?a.fn.fmatter.call(c,
...
true?c.p.localReader.id:c.p.colModel[c.p.keyIndex+e+f+d].name;for(e=0;e<b;e++){f=a.jgrid.getAccessor(c.p.data[e],d);f===void 0&&(f=""+(e+1));c.p._index[f]=e}},H=function(b,d,e,f,g,h){var i="-1",j="",k,d=d?"display:none;":"",e="ui-widget-content jqgrow ui-row-"+c.p.direction+(e?" "+e:"")+(h?" ui-state-highlight":""),h=a(c).triggerHandler("jqGridRowAttr",[f,g,b]);typeof h!=="object"&&(h=a.isFunction(c.p.rowattr)?c.p.rowattr.call(c,f,g,b):{});if(!a.isEmptyObject(h)){if(h.hasOwnProperty("id")){b=h.id;
delete h.id}if(h.hasOwnProperty("tabindex")){i=h.tabindex;delete h.tabindex}if(h.hasOwnProperty("style")){d=d+h.style;delete h.style}if(h.hasOwnProperty("class")){e=e+(" "+h["class"]);delete h["class"]}try{delete h.role}catch(l){}for(k in h)h.hasOwnProperty(k)&&(j=j+(" "+k+"="+h[k]))}return'<tr role="row" id="'+b+'" tabindex="'+i+'" class="'+e+'"'+(d===""?"":' style="'+d+'"')+j+">"},w=function(b,d,e,f,g){var h=new Date,i=c.p.datatype!="local"&&c.p.loadonce||c.p.datatype=="xmlstring",j=c.p.xmlReader,
k=c.p.datatype=="local"?"local":"xml";if(i){c.p.data=[];c.p._index={};c.p.localReader.id="_id_"}c.p.reccount=0;if(a.isXMLDoc(b)){if(c.p.treeANode===-1&&!c.p.scroll){z.call(c,false,true);e=1}else e=e>1?e:1;var l=a(c),m,n,o=0,q,w=c.p.multiselect===true?1:0,v=0,W,E=c.p.rownumbers===true?1:0,u,B=[],y,C={},G,D,A=[],X=c.p.altRows===true?c.p.altclass:"",J;if(c.p.subGrid===true){v=1;W=a.jgrid.getMethod("addSubGridCell")}j.repeatitems||(B=t(k));u=c.p.keyIndex===false?a.isFunction(j.id)?j.id.call(c,b):j.id:
...
0;a.isFunction(j.userdata)?c.p.userData=j.userdata.call(c,b)||{}:a.jgrid.getXmlData(b,j.userdata,true).each(function(){c.p.userData[this.getAttribute("name")]=a(this).text()});b=a.jgrid.getXmlData(b,j.root,true);(b=a.jgrid.getXmlData(b,j.row,true))||(b=[]);var N=b.length,K=0,F=[],I=parseInt(c.p.rowNum,10),M=c.p.scroll?a.jgrid.randId():1;if(N>0&&c.p.page<=0)c.p.page=1;if(b&&N){g&&(I=I*(g+1));var g=a.isFunction(c.p.afterInsertRow),$=false,P;if(c.p.grouping){$=c.p.groupingView.groupCollapse===true;P=
a.jgrid.getMethod("groupingPrepare")}for(;K<N;){G=b[K];D=k(G,M+K);D=c.p.idPrefix+D;m=e===0?0:e+1;J=(m+K)%2==1?X:"";var R=A.length;A.push("");E&&A.push(s(0,K,c.p.page,c.p.rowNum));w&&A.push(r(D,E,K,false));v&&A.push(W.call(l,w+E,K+e));if(j.repeatitems){y||(y=x(w+v+E));var O=a.jgrid.getXmlData(G,j.cell,true);a.each(y,function(a){var b=O[this];if(!b)return false;q=b.textContent||b.text;C[c.p.colModel[a+w+v+E].name]=q;A.push(p(D,q,a+w+v+E,K+e,G,C))})}else for(m=0;m<B.length;m++){q=a.jgrid.getXmlData(G,
B[m]);C[c.p.colModel[m+w+v+E].name]=q;A.push(p(D,q,m+w+v+E,K+e,G,C))}A[R]=H(D,$,J,C,G,false);A.push("</tr>");if(c.p.grouping){F=P.call(l,A,F,C,K);A=[]}if(i||c.p.treeGrid===true){C._id_=a.jgrid.stripPref(c.p.idPrefix,D);c.p.data.push(C);c.p._index[C._id_]=c.p.data.length-1}if(c.p.gridview===false){a("tbody:first",d).append(A.join(""));l.triggerHandler("jqGridAfterInsertRow",[D,C,G]);g&&c.p.afterInsertRow.call(c,D,C,G);A=[]}C={};o++;K++;if(o==I)break}}if(c.p.gridview===true){n=c.p.treeANode>-1?c.p.treeANode:
0;if(c.p.grouping){l.jqGrid("groupingRender",F,c.p.colModel.length);F=null}else c.p.treeGrid===true&&n>0?a(c.rows[n]).after(A.join("")):a("tbody:first",d).append(A.join(""))}if(c.p.subGrid===true)try{l.jqGrid("addSubGrid",w+E)}catch(T){}c.p.totaltime=new Date-h;if(o>0&&c.p.records===0)c.p.records=N;A=null;if(c.p.treeGrid===true)try{l.jqGrid("setTreeNode",n+1,o+n+1)}catch(Q){}if(!c.p.treeGrid&&!c.p.scroll)c.grid.bDiv.scrollTop=0;c.p.reccount=o;c.p.treeANode=-1;c.p.userDataOnFooter&&l.jqGrid("footerData",
"set",c.p.userData,true);if(i){c.p.records=N;c.p.lastpage=Math.ceil(N/I)}f||c.updatepager(false,true);if(i)for(;o<N;){G=b[o];D=k(G,o+M);D=c.p.idPrefix+D;if(j.repeatitems){y||(y=x(w+v+E));var L=a.jgrid.getXmlData(G,j.cell,true);a.each(y,function(a){var b=L[this];if(!b)return false;q=b.textContent||b.text;C[c.p.colModel[a+w+v+E].name]=q})}else for(m=0;m<B.length;m++){q=a.jgrid.getXmlData(G,B[m]);C[c.p.colModel[m+w+v+E].name]=q}C._id_=a.jgrid.stripPref(c.p.idPrefix,D);c.p.data.push(C);c.p._index[C._id_]=
c.p.data.length-1;C={};o++}}},B=function(b,d,e,f,g){var h=new Date;if(b){if(c.p.treeANode===-1&&!c.p.scroll){z.call(c,false,true);e=1}else e=e>1?e:1;var i,j=c.p.datatype!=="local"&&c.p.loadonce||c.p.datatype==="jsonstring";if(j){c.p.data=[];c.p._index={};c.p.localReader.id="_id_"}c.p.reccount=0;if(c.p.datatype==="local"){d=c.p.localReader;i="local"}else{d=c.p.jsonReader;i="json"}var k=a(c),l=0,m,n,o,q=[],w=c.p.multiselect?1:0,v=c.p.subGrid===true?1:0,W,E=c.p.rownumbers===true?1:0,u=x(w+v+E);i=t(i);
var B,A,C,D={},G,y,J=[],X=c.p.altRows===true?c.p.altclass:"",N;c.p.page=a.jgrid.getAccessor(b,d.page)||c.p.page||0;A=a.jgrid.getAccessor(b,d.total);v&&(W=a.jgrid.getMethod("addSubGridCell"));c.p.lastpage=A===void 0?1:A;c.p.records=a.jgrid.getAccessor(b,d.records)||0;c.p.userData=a.jgrid.getAccessor(b,d.userdata)||{};C=c.p.keyIndex===false?a.isFunction(d.id)?d.id.call(c,b):d.id:c.p.keyIndex;if(!d.repeatitems){q=i;if(q.length>0&&!isNaN(C)){c.p.remapColumns&&c.p.remapColumns.length&&(C=a.inArray(C,c.p.remapColumns));
C=q[C]}}A=a.jgrid.getAccessor(b,d.root);A==null&&a.isArray(b)&&(A=b);A||(A=[]);b=A.length;n=0;if(b>0&&c.p.page<=0)c.p.page=1;var K=parseInt(c.p.rowNum,10),F=c.p.scroll?a.jgrid.randId():1,I=false,M;g&&(K=K*(g+1));c.p.datatype==="local"&&!c.p.deselectAfterSort&&(I=true);var $=a.isFunction(c.p.afterInsertRow),P=[],R=false,O;if(c.p.grouping){R=c.p.groupingView.groupCollapse===true;O=a.jgrid.getMethod("groupingPrepare")}for(;n<b;){g=A[n];y=a.jgrid.getAccessor(g,C);if(y===void 0){typeof C==="number"&&c.p.colModel[C+
w+v+E]!=null&&(y=a.jgrid.getAccessor(g,c.p.colModel[C+w+v+E].name));if(y===void 0){y=F+n;if(q.length===0&&d.cell){m=a.jgrid.getAccessor(g,d.cell)||g;y=m!=null&&m[C]!==void 0?m[C]:y}}}y=c.p.idPrefix+y;m=e===1?0:e;N=(m+n)%2===1?X:"";I&&(M=c.p.multiselect?a.inArray(y,c.p.selarrrow)!==-1:y===c.p.selrow);var T=J.length;J.push("");E&&J.push(s(0,n,c.p.page,c.p.rowNum));w&&J.push(r(y,E,n,M));v&&J.push(W.call(k,w+E,n+e));B=i;if(d.repeatitems){d.cell&&(g=a.jgrid.getAccessor(g,d.cell)||g);a.isArray(g)&&(B=u)}for(o=
0;o<B.length;o++){m=a.jgrid.getAccessor(g,B[o]);D[c.p.colModel[o+w+v+E].name]=m;J.push(p(y,m,o+w+v+E,n+e,g,D))}J[T]=H(y,R,N,D,g,M);J.push("</tr>");if(c.p.grouping){P=O.call(k,J,P,D,n);J=[]}if(j||c.p.treeGrid===true){D._id_=a.jgrid.stripPref(c.p.idPrefix,y);c.p.data.push(D);c.p._index[D._id_]=c.p.data.length-1}if(c.p.gridview===false){a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(J.join(""));k.triggerHandler("jqGridAfterInsertRow",[y,D,g]);$&&c.p.afterInsertRow.call(c,y,D,g);J=[]}D={};l++;n++;
if(l===K)break}if(c.p.gridview===true){G=c.p.treeANode>-1?c.p.treeANode:0;c.p.grouping?k.jqGrid("groupingRender",P,c.p.colModel.length):c.p.treeGrid===true&&G>0?a(c.rows[G]).after(J.join("")):a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(J.join(""))}if(c.p.subGrid===true)try{k.jqGrid("addSubGrid",w+E)}catch(Q){}c.p.totaltime=new Date-h;if(l>0&&c.p.records===0)c.p.records=b;if(c.p.treeGrid===true)try{k.jqGrid("setTreeNode",G+1,l+G+1)}catch(L){}if(!c.p.treeGrid&&!c.p.scroll)c.grid.bDiv.scrollTop=
0;c.p.reccount=l;c.p.treeANode=-1;c.p.userDataOnFooter&&k.jqGrid("footerData","set",c.p.userData,true);if(j){c.p.records=b;c.p.lastpage=Math.ceil(b/K)}f||c.updatepager(false,true);if(j)for(;l<b&&A[l];){g=A[l];y=a.jgrid.getAccessor(g,C);if(y===void 0){typeof C==="number"&&c.p.colModel[C+w+v+E]!=null&&(y=a.jgrid.getAccessor(g,c.p.colModel[C+w+v+E].name));if(y===void 0){y=F+l;if(q.length===0&&d.cell){e=a.jgrid.getAccessor(g,d.cell)||g;y=e!=null&&e[C]!==void 0?e[C]:y}}}if(g){y=c.p.idPrefix+y;B=i;if(d.repeatitems){d.cell&&
(g=a.jgrid.getAccessor(g,d.cell)||g);a.isArray(g)&&(B=u)}for(o=0;o<B.length;o++)D[c.p.colModel[o+w+v+E].name]=a.jgrid.getAccessor(g,B[o]);D._id_=a.jgrid.stripPref(c.p.idPrefix,y);c.p.data.push(D);c.p._index[D._id_]=c.p.data.length-1;D={}}l++}}},G=function(){function b(a){var c=0,d,e,g,h,i;if(a.groups!=null){(e=a.groups.length&&a.groupOp.toString().toUpperCase()==="OR")&&p.orBegin();for(d=0;d<a.groups.length;d++){c>0&&e&&p.or();try{b(a.groups[d])}catch(j){alert(j)}c++}e&&p.orEnd()}if(a.rules!=null)try{(g=
a.rules.length&&a.groupOp.toString().toUpperCase()==="OR")&&p.orBegin();for(d=0;d<a.rules.length;d++){i=a.rules[d];h=a.groupOp.toString().toUpperCase();if(o[i.op]&&i.field){c>0&&h&&h==="OR"&&(p=p.or());p=o[i.op](p,h)(i.field,i.data,f[i.field])}c++}g&&p.orEnd()}catch(k){alert(k)}}var d,e=false,f={},g=[],h=[],i,j,k;if(a.isArray(c.p.data)){var l=c.p.grouping?c.p.groupingView:false,m,n;a.each(c.p.colModel,function(){j=this.sorttype||"text";if(j=="date"||j=="datetime"){if(this.formatter&&typeof this.formatter===
"string"&&this.formatter=="date"){i=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:a.jgrid.formatter.date.srcformat;k=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:a.jgrid.formatter.date.newformat}else i=k=this.datefmt||"Y-m-d";f[this.name]={stype:j,srcfmt:i,newfmt:k}}else f[this.name]={stype:j,srcfmt:"",newfmt:""};if(c.p.grouping){n=0;for(m=l.groupField.length;n<m;n++)if(this.name==l.groupField[n]){var b=this.name;if(this.index)b=this.index;
...
false;switch(c.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(c.p.id)).hide();break;case "block":a("#lui_"+a.jgrid.jqID(c.p.id)).hide();a("#load_"+a.jgrid.jqID(c.p.id)).hide()}},F=function(b){if(!c.grid.hDiv.loading){var d=c.p.scroll&&b===false,e={},f,g=c.p.prmNames;if(c.p.page<=0)c.p.page=1;if(g.search!==null)e[g.search]=c.p.search;g.nd!==null&&(e[g.nd]=(new Date).getTime());if(g.rows!==null)e[g.rows]=c.p.rowNum;if(g.page!==null)e[g.page]=c.p.page;if(g.sort!==null)e[g.sort]=c.p.sortname;if(g.order!==
null)e[g.order]=c.p.sortorder;if(c.p.rowTotal!==null&&g.totalrows!==null)e[g.totalrows]=c.p.rowTotal;var h=a.isFunction(c.p.loadComplete),i=h?c.p.loadComplete:null,j=0,b=b||1;if(b>1)if(g.npage!==null){e[g.npage]=b;j=b-1;b=1}else i=function(a){c.p.page++;c.grid.hDiv.loading=false;h&&c.p.loadComplete.call(c,a);F(b-1)};else g.npage!==null&&delete c.p.postData[g.npage];if(c.p.grouping){a(c).jqGrid("groupingSetup");var k=c.p.groupingView,l,m="";for(l=0;l<k.groupField.length;l++){var n=k.groupField[l];
a.each(c.p.colModel,function(a,c){if(c.name==n&&c.index)n=c.index});m=m+(n+" "+k.groupOrder[l]+", ")}e[g.sort]=m+e[g.sort]}a.extend(c.p.postData,e);var o=!c.p.scroll?1:c.rows.length-1,e=a(c).triggerHandler("jqGridBeforeRequest");if(!(e===false||e==="stop"))if(a.isFunction(c.p.datatype))c.p.datatype.call(c,c.p.postData,"load_"+c.p.id);else{if(a.isFunction(c.p.beforeRequest)){e=c.p.beforeRequest.call(c);e===void 0&&(e=true);if(e===false)return}f=c.p.datatype.toLowerCase();switch(f){case "json":case "jsonp":case "xml":case "script":a.ajax(a.extend({url:c.p.url,
...
[e]);c.p.datatype="local";c.p.datastr=null;M();break;case "jsonstring":u();e=typeof c.p.datastr==="string"?a.jgrid.parse(c.p.datastr):c.p.datastr;B(e,c.grid.bDiv);a(c).triggerHandler("jqGridLoadComplete",[e]);h&&c.p.loadComplete.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);c.p.datatype="local";c.p.datastr=null;M();break;case "local":case "clientside":u();c.p.datatype="local";e=G();B(e,c.grid.bDiv,o,b>1,j);a(c).triggerHandler("jqGridLoadComplete",[e]);i&&i.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",
[e]);d&&c.grid.populateVisible();M()}}}},O=function(b){a("#cb_"+a.jgrid.jqID(c.p.id),c.grid.hDiv)[c.p.useProp?"prop":"attr"]("checked",b);if(c.p.frozenColumns&&c.p.id+"_frozen")a("#cb_"+a.jgrid.jqID(c.p.id),c.grid.fhDiv)[c.p.useProp?"prop":"attr"]("checked",b)},T=function(b,d){var e="",f="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",g="",h,j,k,l,m=function(b){var d;a.isFunction(c.p.onPaging)&&(d=c.p.onPaging.call(c,b));c.p.selrow=null;
if(c.p.multiselect){c.p.selarrrow=[];O(false)}c.p.savedRow=[];return d=="stop"?false:true},b=b.substr(1),d=d+("_"+b);h="pg_"+b;j=b+"_left";k=b+"_center";l=b+"_right";a("#"+a.jgrid.jqID(b)).append("<div id='"+h+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+j+"' align='left'></td><td id='"+k+"' align='center' style='white-space:pre;'></td><td id='"+l+"' align='right'></td></tr></tbody></table></div>").attr("dir",
...
"last"+d&&i){c.p.page=b;e=true}e&&F();return false})}c.p.pginput===true&&a("input.ui-pg-input","#"+h).keypress(function(b){if((b.charCode||b.keyCode||0)==13){if(!m("user"))return false;a(this).val(n(a(this).val(),1));c.p.page=a(this).val()>0?a(this).val():c.p.page;F();return false}return this})},U=function(b,d,e,f){if(c.p.colModel[d].sortable&&!(c.p.savedRow.length>0)){if(!e){if(c.p.lastsort==d)if(c.p.sortorder=="asc")c.p.sortorder="desc";else{if(c.p.sortorder=="desc")c.p.sortorder="asc"}else c.p.sortorder=
...
c.p.colModel[d].index||b;e=c.p.sortorder;if(a(c).triggerHandler("jqGridSortCol",[b,d,e])==="stop")c.p.lastsort=d;else if(a.isFunction(c.p.onSortCol)&&c.p.onSortCol.call(c,b,d,e)=="stop")c.p.lastsort=d;else{if(c.p.datatype=="local")c.p.deselectAfterSort&&a(c).jqGrid("resetSelection");else{c.p.selrow=null;c.p.multiselect&&O(false);c.p.selarrrow=[];c.p.savedRow=[]}if(c.p.scroll){e=c.grid.bDiv.scrollLeft;z.call(c,true,false);c.grid.hDiv.scrollLeft=e}c.p.subGrid&&c.p.datatype=="local"&&a("td.sgexpanded",
"#"+a.jgrid.jqID(c.p.id)).each(function(){a(this).trigger("click")});F();c.p.lastsort=d;if(c.p.sortname!=b&&d)c.p.lastsort=d}}},V=function(b){b=a(c.grid.headers[b].el);b=[b.position().left+b.outerWidth()];c.p.direction=="rtl"&&(b[0]=c.p.width-b[0]);b[0]=b[0]-c.grid.bDiv.scrollLeft;b.push(a(c.grid.hDiv).position().top);b.push(a(c.grid.bDiv).offset().top-a(c.grid.hDiv).offset().top+a(c.grid.bDiv).height());return b},Y=function(b){var d,e=c.grid.headers,f=a.jgrid.getCellIndex(b);for(d=0;d<e.length;d++)if(b===
...
id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},c.p.jsonReader);c.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},c.p.localReader);c.p.scroll&&(c.p.pgbuttons=!1,c.p.pginput=!1,c.p.rowList=[]);c.p.data.length&&v();var L="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",W,E,X,D,K,A,y,P;E=P="";if(!0===c.p.shrinkToFit&&!0===c.p.forceFit)for(g=
c.p.colModel.length-1;0<=g;g--)if(!c.p.colModel[g].hidden){c.p.colModel[g].resizable=!1;break}"horizontal"==c.p.viewsortcols[1]&&(P=" ui-i-asc",E=" ui-i-desc");W=k?"class='ui-th-div-ie'":"";P="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+P+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+i+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+E+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+i+"'></span></span>");
for(g=0;g<this.p.colNames.length;g++)E=c.p.headertitles?' title="'+a.jgrid.stripHtml(c.p.colNames[g])+'"':"",L+="<th id='"+c.p.id+"_"+c.p.colModel[g].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+i+"'"+E+">",E=c.p.colModel[g].index||c.p.colModel[g].name,L+="<div id='jqgh_"+c.p.id+"_"+c.p.colModel[g].name+"' "+W+">"+c.p.colNames[g],c.p.colModel[g].width=c.p.colModel[g].width?parseInt(c.p.colModel[g].width,10):150,"boolean"!==typeof c.p.colModel[g].title&&(c.p.colModel[g].title=
!0),E==c.p.sortname&&(c.p.lastsort=g),L+=P+"</div></th>";P=null;a(this).append(L+"</tr></thead>");a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var J=[],R;a("#cb_"+a.jgrid.jqID(c.p.id),this).bind("click",function(){c.p.selarrrow=[];var b=c.p.frozenColumns===true?c.p.id+"_frozen":"";if(this.checked){a(c.rows).each(function(d){if(d>0&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("jqgroup")&&
!a(this).hasClass("ui-state-disabled")){a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id))[c.p.useProp?"prop":"attr"]("checked",true);a(this).addClass("ui-state-highlight").attr("aria-selected","true");c.p.selarrrow.push(this.id);c.p.selrow=this.id;if(b){a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id),c.grid.fbDiv)[c.p.useProp?"prop":"attr"]("checked",true);a("#"+a.jgrid.jqID(this.id),c.grid.fbDiv).addClass("ui-state-highlight")}}});R=true;J=[]}else{a(c.rows).each(function(d){if(d>
0&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("ui-state-disabled")){a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id))[c.p.useProp?"prop":"attr"]("checked",false);a(this).removeClass("ui-state-highlight").attr("aria-selected","false");J.push(this.id);if(b){a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id),c.grid.fbDiv)[c.p.useProp?"prop":"attr"]("checked",false);a("#"+a.jgrid.jqID(this.id),c.grid.fbDiv).removeClass("ui-state-highlight")}}});c.p.selrow=null;R=false}a(c).triggerHandler("jqGridSelectAll",
[R?c.p.selarrrow:J,R]);a.isFunction(c.p.onSelectAll)&&c.p.onSelectAll.call(c,R?c.p.selarrrow:J,R)})}!0===c.p.autowidth&&(L=a(l).innerWidth(),c.p.width=0<L?L:"nw");(function(){var b=0,d=a.jgrid.cell_width?0:n(c.p.cellLayout,0),f=0,g,i=n(c.p.scrollOffset,0),j,k=false,l,m=0,o=0,p;a.each(c.p.colModel,function(){if(this.hidden===void 0)this.hidden=false;if(c.p.grouping&&c.p.autowidth){var e=a.inArray(this.name,c.p.groupingView.groupField);if(e>=0&&c.p.groupingView.groupColumnShow.length>e)this.hidden=
!c.p.groupingView.groupColumnShow[e]}this.widthOrg=j=n(this.width,0);if(this.hidden===false){b=b+(j+d);this.fixed?m=m+(j+d):f++;o++}});if(isNaN(c.p.width))c.p.width=b+(c.p.shrinkToFit===false&&!isNaN(c.p.height)?i:0);e.width=c.p.width;c.p.tblwidth=b;if(c.p.shrinkToFit===false&&c.p.forceFit===true)c.p.forceFit=false;if(c.p.shrinkToFit===true&&f>0){l=e.width-d*f-m;if(!isNaN(c.p.height)){l=l-i;k=true}b=0;a.each(c.p.colModel,function(a){if(this.hidden===false&&!this.fixed){this.width=j=Math.round(l*this.width/
(c.p.tblwidth-d*f-m));b=b+j;g=a}});p=0;k?e.width-m-(b+d*f)!==i&&(p=e.width-m-(b+d*f)-i):!k&&Math.abs(e.width-m-(b+d*f))!==1&&(p=e.width-m-(b+d*f));c.p.colModel[g].width=c.p.colModel[g].width+p;c.p.tblwidth=b+p+d*f+m;if(c.p.tblwidth>c.p.width){c.p.colModel[g].width=c.p.colModel[g].width-(c.p.tblwidth-parseInt(c.p.width,10));c.p.tblwidth=c.p.width}}})();a(l).css("width",e.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+c.p.id+"'>&#160;</div>");a(j).css("width",e.width+"px");var L=a("thead:first",
c).get(0),N="";c.p.footerrow&&(N+="<table role='grid' style='width:"+c.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+i+"'>");var j=a("tr:first",L),Z="<tr class='jqgfirstrow' role='row' style='height:auto'>";c.p.disableClick=!1;a("th",j).each(function(b){X=c.p.colModel[b].width;if(c.p.colModel[b].resizable===void 0)c.p.colModel[b].resizable=true;if(c.p.colModel[b].resizable){D=document.createElement("span");
a(D).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+i).css("cursor","col-resize");a(this).addClass(c.p.resizeclass)}else D="";a(this).css("width",X+"px").prepend(D);var d="";if(c.p.colModel[b].hidden){a(this).css("display","none");d="display:none;"}Z=Z+("<td role='gridcell' style='height:0px;width:"+X+"px;"+d+"'></td>");e.headers[b]={width:X,el:this};K=c.p.colModel[b].sortable;if(typeof K!=="boolean")K=c.p.colModel[b].sortable=true;d=c.p.colModel[b].name;d=="cb"||d=="subgrid"||d=="rn"||
c.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");if(K)if(c.p.viewsortcols[0]){a("div span.s-ico",this).show();b==c.p.lastsort&&a("div span.ui-icon-"+c.p.sortorder,this).removeClass("ui-state-disabled")}else if(b==c.p.lastsort){a("div span.s-ico",this).show();a("div span.ui-icon-"+c.p.sortorder,this).removeClass("ui-state-disabled")}c.p.footerrow&&(N=N+("<td role='gridcell' "+o(b,0,"",null,"",false)+">&#160;</td>"))}).mousedown(function(b){if(a(b.target).closest("th>span.ui-jqgrid-resize").length==
1){var d=Y(this);if(c.p.forceFit===true){var f=c.p,g=d,i;for(i=d+1;i<c.p.colModel.length;i++)if(c.p.colModel[i].hidden!==true){g=i;break}f.nv=g-d}e.dragStart(d,b,V(d));return false}}).click(function(b){if(c.p.disableClick)return c.p.disableClick=false;var d="th>div.ui-jqgrid-sortable",e,f;c.p.viewsortcols[2]||(d="th>div>span>span.ui-grid-ico-sort");b=a(b.target).closest(d);if(b.length==1){d=Y(this);if(!c.p.viewsortcols[2]){e=true;f=b.attr("sort")}U(a("div",this)[0].id,d,e,f);return false}});if(c.p.sortable&&
a.fn.sortable)try{a(c).jqGrid("sortableColumns",j)}catch($){}c.p.footerrow&&(N+="</tr></tbody></table>");Z+="</tr>";this.appendChild(document.createElement("tbody"));a(this).addClass("ui-jqgrid-btable").append(Z);var Z=null,j=a("<table class='ui-jqgrid-htable' style='width:"+c.p.tblwidth+"px' role='grid' aria-labelledby='gbox_"+this.id+"' cellspacing='0' cellpadding='0' border='0'></table>").append(L),S=c.p.caption&&!0===c.p.hiddengrid?!0:!1;g=a("<div class='ui-jqgrid-hbox"+("rtl"==i?"-rtl":"")+"'></div>");
L=null;e.hDiv=document.createElement("div");a(e.hDiv).css({width:e.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(g);a(g).append(j);j=null;S&&a(e.hDiv).hide();c.p.pager&&("string"===typeof c.p.pager?"#"!=c.p.pager.substr(0,1)&&(c.p.pager="#"+c.p.pager):c.p.pager="#"+a(c.p.pager).attr("id"),a(c.p.pager).css({width:e.width+"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(l),S&&a(c.p.pager).hide(),T(c.p.pager,""));!1===c.p.cellEdit&&!0===c.p.hoverrows&&a(c).bind("mouseover",
function(c){y=a(c.target).closest("tr.jqgrow");a(y).attr("class")!=="ui-subgrid"&&a(y).addClass("ui-state-hover")}).bind("mouseout",function(c){y=a(c.target).closest("tr.jqgrow");a(y).removeClass("ui-state-hover")});var I,Q,ca;a(c).before(e.hDiv).click(function(b){A=b.target;y=a(A,c.rows).closest("tr.jqgrow");if(a(y).length===0||y[0].className.indexOf("ui-state-disabled")>-1||(a(A,c).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==c.id)return this;var d=a(A).hasClass("cbox"),
e=a(c).triggerHandler("jqGridBeforeSelectRow",[y[0].id,b]);(e=e===false||e==="stop"?false:true)&&a.isFunction(c.p.beforeSelectRow)&&(e=c.p.beforeSelectRow.call(c,y[0].id,b));if(!(A.tagName=="A"||(A.tagName=="INPUT"||A.tagName=="TEXTAREA"||A.tagName=="OPTION"||A.tagName=="SELECT")&&!d)&&e===true){I=y[0].id;Q=a.jgrid.getCellIndex(A);ca=a(A).closest("td,th").html();a(c).triggerHandler("jqGridCellSelect",[I,Q,ca,b]);a.isFunction(c.p.onCellSelect)&&c.p.onCellSelect.call(c,I,Q,ca,b);if(c.p.cellEdit===true)if(c.p.multiselect&&
d)a(c).jqGrid("setSelection",I,true,b);else{I=y[0].rowIndex;try{a(c).jqGrid("editCell",I,Q,true)}catch(f){}}else if(c.p.multikey)if(b[c.p.multikey])a(c).jqGrid("setSelection",I,true,b);else{if(c.p.multiselect&&d){d=a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+I).is(":checked");a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+I)[c.p.useProp?"prop":"attr"]("checked",d)}}else{if(c.p.multiselect&&c.p.multiboxonly&&!d){var g=c.p.frozenColumns?c.p.id+"_frozen":"";a(c.p.selarrrow).each(function(b,d){var e=c.rows.namedItem(d);a(e).removeClass("ui-state-highlight");
...
"local"){a(c).jqGrid("resetSelection");c.p.data.length&&v()}else if(!c.p.treeGrid){c.p.selrow=null;if(c.p.multiselect){c.p.selarrrow=[];O(false)}c.p.savedRow=[]}c.p.scroll&&z.call(c,true,false);if(d&&d.page){var e=d.page;if(e>c.p.lastpage)e=c.p.lastpage;e<1&&(e=1);c.p.page=e;c.grid.bDiv.scrollTop=c.grid.prevRowHeight?(e-1)*c.grid.prevRowHeight*c.p.rowNum:0}if(c.grid.prevRowHeight&&c.p.scroll){delete c.p.lastpage;c.grid.populateVisible()}else c.grid.populate();c.p._inlinenav===true&&a(c).jqGrid("showAddEditButtons");
return false}).dblclick(function(b){A=b.target;y=a(A,c.rows).closest("tr.jqgrow");if(a(y).length!==0){I=y[0].rowIndex;Q=a.jgrid.getCellIndex(A);a(c).triggerHandler("jqGridDblClickRow",[a(y).attr("id"),I,Q,b]);a.isFunction(c.p.ondblClickRow)&&c.p.ondblClickRow.call(c,a(y).attr("id"),I,Q,b)}}).bind("contextmenu",function(b){A=b.target;y=a(A,c.rows).closest("tr.jqgrow");if(a(y).length!==0){c.p.multiselect||a(c).jqGrid("setSelection",y[0].id,true,b);I=y[0].rowIndex;Q=a.jgrid.getCellIndex(A);a(c).triggerHandler("jqGridRightClickRow",
[a(y).attr("id"),I,Q,b]);a.isFunction(c.p.onRightClickRow)&&c.p.onRightClickRow.call(c,a(y).attr("id"),I,Q,b)}});e.bDiv=document.createElement("div");k&&"auto"===(""+c.p.height).toLowerCase()&&(c.p.height="100%");a(e.bDiv).append(a('<div style="position:relative;'+(k&&8>a.jgrid.msiever()?"height:0.01%;":"")+'"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:c.p.height+(isNaN(c.p.height)?"":"px"),width:e.width+"px"}).scroll(e.scrollGrid);a("table:first",e.bDiv).css({width:c.p.tblwidth+
"px"});a.support.tbody||2==a("tbody",this).length&&a("tbody:gt(0)",this).remove();c.p.multikey&&(a.jgrid.msie?a(e.bDiv).bind("selectstart",function(){return false}):a(e.bDiv).bind("mousedown",function(){return false}));S&&a(e.bDiv).hide();e.cDiv=document.createElement("div");var da=!0===c.p.hidegrid?a("<a role='link' href='javascript:void(0)'/>").addClass("ui-jqgrid-titlebar-close HeaderButton").hover(function(){da.addClass("ui-state-hover")},function(){da.removeClass("ui-state-hover")}).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css("rtl"==
...
"t_"+this.id).insertBefore(e.hDiv),a(e.ubDiv).addClass("ui-userdata ui-state-default").attr("id","tb_"+this.id).insertAfter(e.hDiv),S&&a(e.ubDiv).hide()):a(e.uDiv).width(e.width).addClass("ui-userdata ui-state-default").attr("id","t_"+this.id),S&&a(e.uDiv).hide());c.p.toppager&&(c.p.toppager=a.jgrid.jqID(c.p.id)+"_toppager",e.topDiv=a("<div id='"+c.p.toppager+"'></div>")[0],c.p.toppager="#"+c.p.toppager,a(e.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(e.width).insertBefore(e.hDiv),
T(c.p.toppager,"_t"));c.p.footerrow&&(e.sDiv=a("<div class='ui-jqgrid-sdiv'></div>")[0],g=a("<div class='ui-jqgrid-hbox"+("rtl"==i?"-rtl":"")+"'></div>"),a(e.sDiv).append(g).width(e.width).insertAfter(e.hDiv),a(g).append(N),e.footers=a(".ui-jqgrid-ftable",e.sDiv)[0].rows[0].cells,c.p.rownumbers&&(e.footers[0].className="ui-state-default jqgrid-rownum"),S&&a(e.sDiv).hide());g=null;if(c.p.caption){var ea=c.p.datatype;!0===c.p.hidegrid&&(a(".ui-jqgrid-titlebar-close",e.cDiv).click(function(b){var d=
...
a.jgrid.jqID(c.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(c.p.id)).hide();a(c).triggerHandler("jqGridHeaderClick",[c.p.gridstate,b]);d&&(S||c.p.onHeaderClick.call(c,c.p.gridstate,b))}}):c.p.gridstate=="hidden"&&a(f,"#gbox_"+a.jgrid.jqID(c.p.id)).slideDown("fast",function(){g--;if(g===0){a("span",i).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n");if(S){c.p.datatype=ea;F();S=false}c.p.gridstate="visible";a("#gbox_"+a.jgrid.jqID(c.p.id)).hasClass("ui-resizable")&&
a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(c.p.id)).show();a(c).triggerHandler("jqGridHeaderClick",[c.p.gridstate,b]);d&&(S||c.p.onHeaderClick.call(c,c.p.gridstate,b))}});return false}),S&&(c.p.datatype="local",a(".ui-jqgrid-titlebar-close",e.cDiv).trigger("click")))}else a(e.cDiv).hide();a(e.hDiv).after(e.bDiv).mousemove(function(a){if(e.resizing){e.dragMove(a);return false}});a(".ui-jqgrid-labels",e.hDiv).bind("selectstart",function(){return false});a(document).mouseup(function(){if(e.resizing){e.dragEnd();
return false}return true});c.formatCol=o;c.sortData=U;c.updatepager=function(b,d){var e,f,g,h,i,j,k,m="",l=c.p.pager?"_"+a.jgrid.jqID(c.p.pager.substr(1)):"",o=c.p.toppager?"_"+c.p.toppager.substr(1):"";g=parseInt(c.p.page,10)-1;g<0&&(g=0);g=g*parseInt(c.p.rowNum,10);i=g+c.p.reccount;if(c.p.scroll){e=a("tbody:first > tr:gt(0)",c.grid.bDiv);g=i-e.length;c.p.reccount=e.length;if(f=e.outerHeight()||c.grid.prevRowHeight){e=g*f;f=parseInt(c.p.records,10)*f;a(">div:first",c.grid.bDiv).css({height:f}).children("div:first").css({height:e,
display:e?"":"none"})}c.grid.bDiv.scrollLeft=c.grid.hDiv.scrollLeft}m=c.p.pager||"";if(m=m+(c.p.toppager?m?","+c.p.toppager:c.p.toppager:"")){k=a.jgrid.formatter.integer||{};e=n(c.p.page);f=n(c.p.lastpage);a(".selbox",m)[this.p.useProp?"prop":"attr"]("disabled",false);if(c.p.pginput===true){a(".ui-pg-input",m).val(c.p.page);h=c.p.toppager?"#sp_1"+l+",#sp_1"+o:"#sp_1"+l;a(h).html(a.fmatter?a.fmatter.util.NumberFormat(c.p.lastpage,k):c.p.lastpage)}if(c.p.viewrecords)if(c.p.reccount===0)a(".ui-paging-info",
m).html(c.p.emptyrecords);else{h=g+1;j=c.p.records;if(a.fmatter){h=a.fmatter.util.NumberFormat(h,k);i=a.fmatter.util.NumberFormat(i,k);j=a.fmatter.util.NumberFormat(j,k)}a(".ui-paging-info",m).html(a.jgrid.format(c.p.recordtext,h,i,j))}if(c.p.pgbuttons===true){e<=0&&(e=f=0);if(e==1||e===0){a("#first"+l+", #prev"+l).addClass("ui-state-disabled").removeClass("ui-state-hover");c.p.toppager&&a("#first_t"+o+", #prev_t"+o).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{a("#first"+l+", #prev"+
l).removeClass("ui-state-disabled");c.p.toppager&&a("#first_t"+o+", #prev_t"+o).removeClass("ui-state-disabled")}if(e==f||e===0){a("#next"+l+", #last"+l).addClass("ui-state-disabled").removeClass("ui-state-hover");c.p.toppager&&a("#next_t"+o+", #last_t"+o).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{a("#next"+l+", #last"+l).removeClass("ui-state-disabled");c.p.toppager&&a("#next_t"+o+", #last_t"+o).removeClass("ui-state-disabled")}}}b===true&&c.p.rownumbers===true&&a("td.jqgrid-rownum",
c.rows).each(function(b){a(this).html(g+1+b)});d&&c.p.jqgdnd&&a(c).jqGrid("gridDnD","updateDnD");a(c).triggerHandler("jqGridGridComplete");a.isFunction(c.p.gridComplete)&&c.p.gridComplete.call(c);a(c).triggerHandler("jqGridAfterGridComplete")};c.refreshIndex=v;c.setHeadCheckBox=O;c.constructTr=H;c.formatter=function(a,b,c,d,e){return q(a,b,c,d,e)};a.extend(e,{populate:F,emptyRows:z});this.grid=e;c.addXmlData=function(a){w(a,c.grid.bDiv)};c.addJSONData=function(a){B(a,c.grid.bDiv)};this.grid.cols=
this.rows[0].cells;a(c).triggerHandler("jqGridInitGrid");a.isFunction(c.p.onInitGrid)&&c.p.onInitGrid.call(c);F();c.p.hiddengrid=!1}}}})};a.jgrid.extend({getGridParam:function(a){var e=this[0];return!e||!e.grid?void 0:!a?e.p:void 0!==e.p[a]?e.p[a]:null},setGridParam:function(d){return this.each(function(){this.grid&&"object"===typeof d&&a.extend(!0,this.p,d)})},getDataIDs:function(){var d=[],e=0,b,f=0;this.each(function(){if((b=this.rows.length)&&0<b)for(;e<b;)a(this.rows[e]).hasClass("jqgrow")&&
...
0<this.p.selarrrow.length?this.p.selarrrow[this.p.selarrrow.length-1]:null;if("local"===this.p.datatype){var c=this.p._index[a.jgrid.stripPref(this.p.idPrefix,d)];void 0!==c&&(this.p.data.splice(c,1),this.refreshIndex())}if(!0===this.p.altRows&&e){var h=this.p.altclass;a(this.rows).each(function(b){b%2==1?a(this).addClass(h):a(this).removeClass(h)})}});return e},setRowData:function(d,e,b){var f,c=!0,h;this.each(function(){if(!this.grid)return!1;var g=this,i,j,k=typeof b,l={};j=g.rows.namedItem(d);
if(!j)return!1;if(e)try{if(a(this.p.colModel).each(function(b){f=this.name;void 0!==e[f]&&(l[f]=this.formatter&&"string"===typeof this.formatter&&"date"==this.formatter?a.unformat.date.call(g,e[f],this):e[f],i=g.formatter(d,e[f],b,e,"edit"),h=this.title?{title:a.jgrid.stripHtml(i)}:{},!0===g.p.treeGrid&&f==g.p.ExpandColumn?a("td[role='gridcell']:eq("+b+") > span:first",j).html(i).attr(h):a("td[role='gridcell']:eq("+b+")",j).html(i).attr(h))}),"local"===g.p.datatype){var n=a.jgrid.stripPref(g.p.idPrefix,
d),o=g.p._index[n],m;if(g.p.treeGrid)for(m in g.p.treeReader)g.p.treeReader.hasOwnProperty(m)&&delete l[g.p.treeReader[m]];void 0!==o&&(g.p.data[o]=a.extend(!0,g.p.data[o],l));l=null}}catch(q){c=!1}c&&("string"===k?a(j).addClass(b):"object"===k&&a(j).css(b),a(g).triggerHandler("jqGridAfterGridComplete"))});return c},addRowData:function(d,e,b,f){b||(b="last");var c=!1,h,g,i,j,k,l,n,o,m="",q,p,r,s,t,x;e&&(a.isArray(e)?(q=!0,b="last",p=d):(e=[e],q=!1),this.each(function(){var z=e.length;k=this.p.rownumbers===
true?1:0;i=this.p.multiselect===true?1:0;j=this.p.subGrid===true?1:0;if(!q)if(d!==void 0)d=""+d;else{d=a.jgrid.randId();if(this.p.keyIndex!==false){p=this.p.colModel[this.p.keyIndex+i+j+k].name;e[0][p]!==void 0&&(d=e[0][p])}}r=this.p.altclass;for(var v=0,H="",w={},B=a.isFunction(this.p.afterInsertRow)?true:false;v<z;){s=e[v];g=[];if(q){try{d=s[p];d===void 0&&(d=a.jgrid.randId())}catch(G){d=a.jgrid.randId()}H=this.p.altRows===true?(this.rows.length-1)%2===0?r:"":""}x=d;d=this.p.idPrefix+d;if(k){m=
this.formatCol(0,1,"",null,d,true);g[g.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+m+">0</td>"}if(i){o='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+d+'" class="cbox"/>';m=this.formatCol(k,1,"",null,d,true);g[g.length]='<td role="gridcell" '+m+">"+o+"</td>"}j&&(g[g.length]=a(this).jqGrid("addSubGridCell",i+k,1));for(n=i+j+k;n<this.p.colModel.length;n++){t=this.p.colModel[n];h=t.name;w[h]=s[h];o=this.formatter(d,a.jgrid.getAccessor(s,h),n,s);m=this.formatCol(n,
1,o,s,d,w);g[g.length]='<td role="gridcell" '+m+">"+o+"</td>"}g.unshift(this.constructTr(d,false,H,w,s,false));g[g.length]="</tr>";if(this.rows.length===0)a("table:first",this.grid.bDiv).append(g.join(""));else switch(b){case "last":a(this.rows[this.rows.length-1]).after(g.join(""));l=this.rows.length-1;break;case "first":a(this.rows[0]).after(g.join(""));l=1;break;case "after":(l=this.rows.namedItem(f))&&(a(this.rows[l.rowIndex+1]).hasClass("ui-subgrid")?a(this.rows[l.rowIndex+1]).after(g):a(l).after(g.join("")));
l++;break;case "before":if(l=this.rows.namedItem(f)){a(l).before(g.join(""));l=l.rowIndex}l--}this.p.subGrid===true&&a(this).jqGrid("addSubGrid",i+k,l);this.p.records++;this.p.reccount++;a(this).triggerHandler("jqGridAfterInsertRow",[d,s,s]);B&&this.p.afterInsertRow.call(this,d,s,s);v++;if(this.p.datatype==="local"){w[this.p.localReader.id]=x;this.p._index[x]=this.p.data.length;this.p.data.push(w);w={}}}this.p.altRows===true&&!q&&(b==="last"?(this.rows.length-1)%2===1&&a(this.rows[this.rows.length-
1]).addClass(r):a(this.rows).each(function(b){b%2===1?a(this).addClass(r):a(this).removeClass(r)}));this.updatepager(true,true);c=true}));return c},footerData:function(d,e,b){function f(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0}var c,h=!1,g={},i;void 0===d&&(d="get");"boolean"!==typeof b&&(b=!0);d=d.toLowerCase();this.each(function(){var j=this,k;if(!j.grid||!j.p.footerrow||"set"==d&&f(e))return!1;h=!0;a(this.p.colModel).each(function(f){c=this.name;"set"==d?void 0!==e[c]&&(k=b?j.formatter("",
e[c],f,e,"edit"):e[c],i=this.title?{title:a.jgrid.stripHtml(k)}:{},a("tr.footrow td:eq("+f+")",j.grid.sDiv).html(k).attr(i),h=!0):"get"==d&&(g[c]=a("tr.footrow td:eq("+f+")",j.grid.sDiv).html())})});return"get"==d?g:h},showHideCol:function(d,e){return this.each(function(){var b=this,f=!1,c=a.jgrid.cell_width?0:b.p.cellLayout,h;if(b.grid){"string"===typeof d&&(d=[d]);e="none"!=e?"":"none";var g=""===e?!0:!1,i=b.p.groupHeader&&("object"===typeof b.p.groupHeader||a.isFunction(b.p.groupHeader));i&&a(b).jqGrid("destroyGroupHeader",
...
c=c+(f+h);this.fixed?n=n+(f+h):i++;o++}});if(0===i)return;b.p.tblwidth=c;l=d-h*i-n;if(!isNaN(b.p.height)&&(a(b.grid.bDiv)[0].clientHeight<a(b.grid.bDiv)[0].scrollHeight||1===b.rows.length))j=!0,l-=k;var c=0,q=0<b.grid.cols.length;a.each(b.p.colModel,function(a){if(this.hidden===false&&!this.fixed){f=this.widthOrg;f=Math.round(l*f/(b.p.tblwidth-h*i-n));if(!(f<0)){this.width=f;c=c+f;b.grid.headers[a].width=f;b.grid.headers[a].el.style.width=f+"px";if(b.p.footerrow)b.grid.footers[a].style.width=f+"px";
if(q)b.grid.cols[a].style.width=f+"px";g=a}}});if(!g)return;m=0;j?d-n-(c+h*i)!==k&&(m=d-n-(c+h*i)-k):1!==Math.abs(d-n-(c+h*i))&&(m=d-n-(c+h*i));b.p.colModel[g].width+=m;b.p.tblwidth=c+m+h*i+n;b.p.tblwidth>d?(j=b.p.tblwidth-parseInt(d,10),b.p.tblwidth=d,f=b.p.colModel[g].width-=j):f=b.p.colModel[g].width;b.grid.headers[g].width=f;b.grid.headers[g].el.style.width=f+"px";q&&(b.grid.cols[g].style.width=f+"px");b.p.footerrow&&(b.grid.footers[g].style.width=f+"px")}b.p.tblwidth&&(a("table:first",b.grid.bDiv).css("width",
...
setCell:function(d,e,b,f,c,h){return this.each(function(){var g=-1,i,j;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name===e)return g=a,!1}):g=parseInt(e,10),0<=g&&(i=this.rows.namedItem(d)))){var k=a("td:eq("+g+")",i);if(""!==b||!0===h)i=this.formatter(d,b,g,i,"edit"),j=this.p.colModel[g].title?{title:a.jgrid.stripHtml(i)}:{},this.p.treeGrid&&0<a(".tree-wrap",a(k)).length?a("span",a(k)).html(i).attr(j):a(k).html(i).attr(j),"local"===this.p.datatype&&(i=this.p.colModel[g],b=
i.formatter&&"string"===typeof i.formatter&&"date"===i.formatter?a.unformat.date.call(this,b,i):b,j=this.p._index[a.jgrid.stripPref(this.p.idPrefix,d)],void 0!==j&&(this.p.data[j][i.name]=b));"string"===typeof f?a(k).addClass(f):f&&a(k).css(f);"object"===typeof c&&a(k).attr(c)}})},getCell:function(d,e){var b=!1;this.each(function(){var f=-1;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name===e)return f=a,!1}):f=parseInt(e,10),0<=f)){var c=this.rows.namedItem(d);if(c)try{b=a.unformat.call(this,
a("td:eq("+f+")",c),{rowId:c.id,colModel:this.p.colModel[f]},f)}catch(h){b=a.jgrid.htmlDecode(a("td:eq("+f+")",c).html())}}});return b},getCol:function(d,e,b){var f=[],c,h=0,g,i,j,e="boolean"!==typeof e?!1:e;void 0===b&&(b=!1);this.each(function(){var k=-1;if(this.grid&&(isNaN(d)?a(this.p.colModel).each(function(a){if(this.name===d)return k=a,!1}):k=parseInt(d,10),0<=k)){var l=this.rows.length,n=0;if(l&&0<l){for(;n<l;){if(a(this.rows[n]).hasClass("jqgrow")){try{c=a.unformat.call(this,a(this.rows[n].cells[k]),
{rowId:this.rows[n].id,colModel:this.p.colModel[k]},k)}catch(o){c=a.jgrid.htmlDecode(this.rows[n].cells[k].innerHTML)}b?(j=parseFloat(c),h+=j,void 0===i&&(i=g=j),g=Math.min(g,j),i=Math.max(i,j)):e?f.push({id:this.rows[n].id,value:c}):f.push(c)}n++}if(b)switch(b.toLowerCase()){case "sum":f=h;break;case "avg":f=h/l;break;case "count":f=l;break;case "min":f=g;break;case "max":f=i}}}});return f},clearGridData:function(d){return this.each(function(){if(this.grid){"boolean"!==typeof d&&(d=!1);if(this.p.deepempty)a("#"+
...
h.append(i),i=a("<td colspan='4'></td>"),i.append(this.createTableForGroup(b.groups[e],b)),h.append(i);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)g.append(this.createTableRowForRule(b.rules[e],b));return g};this.createTableRowForRule=function(b,c){var d=this,e=a("<tr></tr>"),g,h,j,r,s="",t;e.append("<td class='first'></td>");var x=a("<td class='columns'></td>");e.append(x);var z=a("<select></select>"),v,H=[];x.append(z);z.bind("change",function(){b.field=
a(z).val();j=a(this).parents("tr:first");for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===b.field){r=d.p.columns[g];break}if(r){r.searchoptions.id=a.jgrid.randId();i&&"text"===r.inputtype&&!r.searchoptions.size&&(r.searchoptions.size=10);var c=a.jgrid.createEl(r.inputtype,r.searchoptions,"",!0,d.p.ajaxSelectOptions,!0);a(c).addClass("input-elm");h=r.searchoptions.sopt?r.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(r.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;var e="",f=0;H=[];
a.each(d.p.ops,function(){H.push(this.name)});for(g=0;g<h.length;g++)v=a.inArray(h[g],H),-1!==v&&(0===f&&(b.op=d.p.ops[v].name),e+="<option value='"+d.p.ops[v].name+"'>"+d.p.ops[v].description+"</option>",f++);a(".selectopts",j).empty().append(e);a(".selectopts",j)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(e=parseInt(a("select.selectopts",j)[0].offsetWidth,10)+1,a(".selectopts",j).width(e),a(".selectopts",j).css("width","auto"));a(".data",j).empty().append(c);a.jgrid.bindEv(c,r.searchoptions,
...
"eq";0<=t&&n[t].searchoptions&&n[t].searchoptions.sopt?x=n[t].searchoptions.sopt[0]:d.sopt&&d.sopt.length&&(x=d.sopt[0]);i={groupOp:"AND",rules:[{field:r,op:x,data:""}]}}s=!1;d.tmplNames&&d.tmplNames.length&&(s=!0,p=d.tmplLabel,p+="<select class='ui-template'>",p+="<option value='default'>Default</option>",a.each(d.tmplNames,function(a,b){p=p+("<option value='"+a+"'>"+b+"</option>")}),p+="</select>");k="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+c+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+
...
c.p.ExpandColumn&&!0===c.p.treeGrid)k=a("td[role='gridcell']:eq("+t+")",c.rows[q]).text();else{try{k=a.unformat.call(c,a("td[role='gridcell']:eq("+t+")",c.rows[q]),{rowId:b,colModel:this},t)}catch(r){k=this.edittype&&"textarea"==this.edittype?a("td[role='gridcell']:eq("+t+")",c.rows[q]).text():a("td[role='gridcell']:eq("+t+")",c.rows[q]).html()}if(!k||"&nbsp;"==k||"&#160;"==k||1==k.length&&160==k.charCodeAt(0))k=""}var w=a.extend({},this.editoptions||{},{id:g,name:g}),x=a.extend({},{elmprefix:"",
elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),v=parseInt(x.rowpos,10)||j+1,u=parseInt(2*(parseInt(x.colpos,10)||1),10);"_empty"==b&&w.defaultValue&&(k=a.isFunction(w.defaultValue)?w.defaultValue.call(m):w.defaultValue);this.edittype||(this.edittype="text");m.p.autoencode&&(k=a.jgrid.htmlDecode(k));n=a.jgrid.createEl.call(m,this.edittype,w,k,!1,a.extend({},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||{}));if(d[m.p.id].checkOnSubmit||d[m.p.id].checkOnUpdate)d[m.p.id]._savedData[g]=k;a(n).addClass("FormElement");
-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(n).addClass("ui-widget-content ui-corner-all");i=a(e).find("tr[rowpos="+v+"]");if(x.rowabove){var B=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+x.rowcontent+"</td></tr>");a(e).append(B);B[0].rp=v}0===i.length&&(i=a("<tr "+l+" rowpos='"+v+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(i).append(s),a(e).append(i),i[0].rp=v);a("td:eq("+(u-2)+")",i[0]).html(void 0===x.label?c.p.colNames[t]:x.label);a("td:eq("+(u-1)+")",
i[0]).append(x.elmprefix).append(n).append(x.elmsuffix);a.isFunction(w.custom_value)&&"_empty"!==b&&w.custom_value.call(m,a("#"+g,"#"+p),"set",k);a.jgrid.bindEv(n,w,m);o[j]=t;j++}});if(0<j&&(t=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+c.p.id+"_id' value='"+b+"'/></td></tr>"),t[0].rp=j+999,a(e).append(t),d[m.p.id].checkOnSubmit||d[m.p.id].checkOnUpdate))d[m.p.id]._savedData[c.p.id+
"_id"]=b;return o}function h(b,c,e){var f,g=0,h,i,j,k,l;if(d[m.p.id].checkOnSubmit||d[m.p.id].checkOnUpdate)d[m.p.id]._savedData={},d[m.p.id]._savedData[c.p.id+"_id"]=b;var n=c.p.colModel;if("_empty"==b)a(n).each(function(){f=this.name;j=a.extend({},this.editoptions||{});if((i=a("#"+a.jgrid.jqID(f),"#"+e))&&i.length&&null!==i[0])if(k="",j.defaultValue?(k=a.isFunction(j.defaultValue)?j.defaultValue.call(m):j.defaultValue,"checkbox"==i[0].type?(l=k.toLowerCase(),0>l.search(/(false|f|0|no|n|off|undefined)/i)&&
...
"editurl"),type:d[m.p.id].mtype,data:a.isFunction(d[m.p.id].serializeEditData)?d[m.p.id].serializeEditData.call(m,u):u,complete:function(f,g){var l;u[j]=m.p.idPrefix+u[j];if(f.status>=300&&f.status!==304){e[0]=false;e[1]=a(m).triggerHandler("jqGridAddEditErrorTextFormat",[f,F]);e[1]=a.isFunction(d[m.p.id].errorTextFormat)?d[m.p.id].errorTextFormat.call(m,f):g+" Status: '"+f.statusText+"'. Error code: "+f.status}else{e=a(m).triggerHandler("jqGridAddEditAfterSubmit",[f,u,F]);e===void 0&&(e=[true,"",
""]);e[0]&&a.isFunction(d[m.p.id].afterSubmit)&&(e=d[m.p.id].afterSubmit.call(m,f,u))}if(e[0]===false){a("#FormError>td",s).html(e[1]);a("#FormError",s).show()}else{m.p.autoencode&&a.each(u,function(b,c){u[b]=a.jgrid.htmlDecode(c)});if(u[k]===i.addoper){e[2]||(e[2]=a.jgrid.randId());u[j]=e[2];if(d[m.p.id].reloadAfterSubmit)a(m).trigger("reloadGrid");else{m.p.treeGrid===true?a(m).jqGrid("addChildNode",e[2],n,u):a(m).jqGrid("addRowData",e[2],u,b.addedrow);if(d[m.p.id].closeAfterAdd){m.p.treeGrid!==
true&&a(m).jqGrid("setSelection",e[2]);a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[m.p.id].onClose})}else d[m.p.id].clearAfterAdd&&h("_empty",m,p)}}else{if(d[m.p.id].reloadAfterSubmit){a(m).trigger("reloadGrid");d[m.p.id].closeAfterEdit||setTimeout(function(){a(m).jqGrid("setSelection",u[j])},1E3)}else m.p.treeGrid===true?a(m).jqGrid("setTreeRow",u[j],u):a(m).jqGrid("setRowData",u[j],u);d[m.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),
{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[m.p.id].onClose})}if(a.isFunction(d[m.p.id].afterComplete)){c=f;setTimeout(function(){a(m).triggerHandler("jqGridAddEditAfterComplete",[c,u,a("#"+p),F]);d[m.p.id].afterComplete.call(m,c,u,a("#"+p));c=null},500)}if(d[m.p.id].checkOnSubmit||d[m.p.id].checkOnUpdate){a("#"+p).data("disabled",false);if(d[m.p.id]._savedData[m.p.id+"_id"]!="_empty")for(l in d[m.p.id]._savedData)d[m.p.id]._savedData.hasOwnProperty(l)&&u[l]&&(d[m.p.id]._savedData[l]=u[l])}}d[m.p.id].processing=
false;a("#sData",s+"_2").removeClass("ui-state-active");try{a(":input:visible","#"+p)[0].focus()}catch(o){}}},a.jgrid.ajaxOptions,d[m.p.id].ajaxEditOptions);!o.url&&!d[m.p.id].useDataProxy&&(a.isFunction(m.p.dataProxy)?d[m.p.id].useDataProxy=!0:(e[0]=!1,e[1]+=" "+a.jgrid.errors.nourl));e[0]&&(d[m.p.id].useDataProxy?(f=m.p.dataProxy.call(m,o,"set_"+m.p.id),void 0===f&&(f=[!0,""]),!1===f[0]?(e[0]=!1,e[1]=f[1]||"Error deleting the selected row!"):(o.data.oper==i.addoper&&d[m.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+
a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[m.p.id].onClose}),o.data.oper==i.editoper&&d[m.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[m.p.id].onClose}))):a.ajax(o))}!1===e[0]&&(a("#FormError>td",s).html(e[1]),a("#FormError",s).show())}function j(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&a[d]!=b[d]){c=!0;break}return c}function k(){var b=!0;a("#FormError",s).hide();if(d[m.p.id].checkOnUpdate&&
(u={},f(),M=j(u,d[m.p.id]._savedData)))a("#"+p).data("disabled",!0),a(".confirm","#"+t.themodal).show(),b=!1;return b}function l(){var b;if("_empty"!==e&&void 0!==m.p.savedRow&&0<m.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<m.p.savedRow.length;b++)if(m.p.savedRow[b].id==e){a(m).jqGrid("restoreRow",e);break}}function n(b,c){var d=c[1].length-1;0===b?a("#pData",s+"_2").addClass("ui-state-disabled"):void 0!==c[1][b-1]&&a("#"+a.jgrid.jqID(c[1][b-1])).hasClass("ui-state-disabled")?
a("#pData",s+"_2").addClass("ui-state-disabled"):a("#pData",s+"_2").removeClass("ui-state-disabled");b==d?a("#nData",s+"_2").addClass("ui-state-disabled"):void 0!==c[1][b+1]&&a("#"+a.jgrid.jqID(c[1][b+1])).hasClass("ui-state-disabled")?a("#nData",s+"_2").addClass("ui-state-disabled"):a("#nData",s+"_2").removeClass("ui-state-disabled")}function o(){var b=a(m).jqGrid("getDataIDs"),c=a("#id_g",s).val();return[a.inArray(c,b),b]}var m=this;if(m.grid&&e){var q=m.p.id,p="FrmGrid_"+q,r="TblGrid_"+q,s="#"+
a.jgrid.jqID(r),t={themodal:"editmod"+q,modalhead:"edithd"+q,modalcontent:"editcnt"+q,scrollelm:p},x=a.isFunction(d[m.p.id].beforeShowForm)?d[m.p.id].beforeShowForm:!1,z=a.isFunction(d[m.p.id].afterShowForm)?d[m.p.id].afterShowForm:!1,v=a.isFunction(d[m.p.id].beforeInitData)?d[m.p.id].beforeInitData:!1,H=a.isFunction(d[m.p.id].onInitializeForm)?d[m.p.id].onInitializeForm:!1,w=!0,B=1,G=0,u,M,F,p=a.jgrid.jqID(p);"new"===e?(e="_empty",F="add",b.caption=d[m.p.id].addCaption):(b.caption=d[m.p.id].editCaption,
F="edit");!0===b.recreateForm&&void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]&&a("#"+a.jgrid.jqID(t.themodal)).remove();var O=!0;b.checkOnUpdate&&b.jqModal&&!b.modal&&(O=!1);if(void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]){w=a(m).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+a.jgrid.jqID(p)),F]);void 0===w&&(w=!0);w&&v&&(w=v.call(m,a("#"+p)));if(!1===w)return;l();a(".ui-jqdialog-title","#"+a.jgrid.jqID(t.modalhead)).html(b.caption);a("#FormError",s).hide();d[m.p.id].topinfo?(a(".topinfo",s).html(d[m.p.id].topinfo),
a(".tinfo",s).show()):a(".tinfo",s).hide();d[m.p.id].bottominfo?(a(".bottominfo",s+"_2").html(d[m.p.id].bottominfo),a(".binfo",s+"_2").show()):a(".binfo",s+"_2").hide();h(e,m,p);"_empty"==e||!d[m.p.id].viewPagerButtons?a("#pData, #nData",s+"_2").hide():a("#pData, #nData",s+"_2").show();!0===d[m.p.id].processing&&(d[m.p.id].processing=!1,a("#sData",s+"_2").removeClass("ui-state-active"));!0===a("#"+p).data("disabled")&&(a(".confirm","#"+a.jgrid.jqID(t.themodal)).hide(),a("#"+p).data("disabled",!1));
a(m).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+p),F]);x&&x.call(m,a("#"+p));a("#"+a.jgrid.jqID(t.themodal)).data("onClose",d[m.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,jqM:!1,overlay:b.overlay,modal:b.modal});O||a(".jqmOverlay").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[m.p.id].onClose});return false});a(m).triggerHandler("jqGridAddEditAfterShowForm",
[a("#"+p),F]);z&&z.call(m,a("#"+p))}else{var T=isNaN(b.dataheight)?b.dataheight:b.dataheight+"px",w=isNaN(b.datawidth)?b.datawidth:b.datawidth+"px",T=a("<form name='FormPost' id='"+p+"' class='FormGrid' onSubmit='return false;' style='width:"+w+";overflow:auto;position:relative;height:"+T+";'></form>").data("disabled",!1),U=a("<table id='"+r+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),w=a(m).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+p),F]);void 0===
w&&(w=!0);w&&v&&(w=v.call(m,a("#"+p)));if(!1===w)return;l();a(m.p.colModel).each(function(){var a=this.formoptions;B=Math.max(B,a?a.colpos||0:0);G=Math.max(G,a?a.rowpos||0:0)});a(T).append(U);v=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+2*B+"'></td></tr>");v[0].rp=0;a(U).append(v);v=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*B+"'>"+d[m.p.id].topinfo+"</td></tr>");v[0].rp=0;a(U).append(v);var w=(v="rtl"==m.p.direction?!0:!1)?"nData":
"pData",V=v?"pData":"nData";c(e,m,U,B);var w="<a href='javascript:void(0)' id='"+w+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",V="<a href='javascript:void(0)' id='"+V+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",Y="<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>"+b.bSubmit+"</a>",aa="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+
b.bCancel+"</a>",r="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+r+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+(v?V+w:w+V)+"</td><td class='EditButton'>"+Y+aa+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+d[m.p.id].bottominfo+"</td></tr>"),r=r+"</tbody></table>";if(0<G){var ba=[];a.each(a(U)[0].rows,function(a,b){ba[a]=b});ba.sort(function(a,
b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(ba,function(b,c){a("tbody",U).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(q);var L=!1;!0===b.closeOnEscape&&(b.closeOnEscape=!1,L=!0);r=a("<div></div>").append(T).append(r);a.jgrid.createModal(t,r,b,"#gview_"+a.jgrid.jqID(m.p.id),a("#gbox_"+a.jgrid.jqID(m.p.id))[0]);v&&(a("#pData, #nData",s+"_2").css("float","right"),a(".EditButton",s+"_2").css("text-align","left"));d[m.p.id].topinfo&&a(".tinfo",s).show();d[m.p.id].bottominfo&&a(".binfo",s+"_2").show();r=
r=null;a("#"+a.jgrid.jqID(t.themodal)).keydown(function(c){var e=c.target;if(a("#"+p).data("disabled")===true)return false;if(d[m.p.id].savekey[0]===true&&c.which==d[m.p.id].savekey[1]&&e.tagName!="TEXTAREA"){a("#sData",s+"_2").trigger("click");return false}if(c.which===27){if(!k())return false;L&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:b.gbox,jqm:b.jqModal,onClose:d[m.p.id].onClose});return false}if(d[m.p.id].navkeys[0]===true){if(a("#id_g",s).val()=="_empty")return true;if(c.which==d[m.p.id].navkeys[1]){a("#pData",
s+"_2").trigger("click");return false}if(c.which==d[m.p.id].navkeys[2]){a("#nData",s+"_2").trigger("click");return false}}});b.checkOnUpdate&&(a("a.ui-jqdialog-titlebar-close span","#"+a.jgrid.jqID(t.themodal)).removeClass("jqmClose"),a("a.ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(t.themodal)).unbind("click").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[m.p.id].onClose});return false}));b.saveicon=a.extend([!0,
"left","ui-icon-disk"],b.saveicon);b.closeicon=a.extend([!0,"left","ui-icon-close"],b.closeicon);!0===b.saveicon[0]&&a("#sData",s+"_2").addClass("right"==b.saveicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.saveicon[2]+"'></span>");!0===b.closeicon[0]&&a("#cData",s+"_2").addClass("right"==b.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.closeicon[2]+"'></span>");if(d[m.p.id].checkOnSubmit||d[m.p.id].checkOnUpdate)Y=
"<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bYes+"</a>",V="<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bNo+"</a>",aa="<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bExit+"</a>",r=b.zIndex||999,r++,a("<div class='ui-widget-overlay jqgrid-overlay confirm' style='z-index:"+r+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+
(r+1)+"'>"+b.saveData+"<br/><br/>"+Y+V+aa+"</div>").insertAfter("#"+p),a("#sNew","#"+a.jgrid.jqID(t.themodal)).click(function(){i();a("#"+p).data("disabled",false);a(".confirm","#"+a.jgrid.jqID(t.themodal)).hide();return false}),a("#nNew","#"+a.jgrid.jqID(t.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(t.themodal)).hide();a("#"+p).data("disabled",false);setTimeout(function(){a(":input:visible","#"+p)[0].focus()},0);return false}),a("#cNew","#"+a.jgrid.jqID(t.themodal)).click(function(){a(".confirm",
"#"+a.jgrid.jqID(t.themodal)).hide();a("#"+p).data("disabled",false);a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[m.p.id].onClose});return false});a(m).triggerHandler("jqGridAddEditInitializeForm",[a("#"+p),F]);H&&H.call(m,a("#"+p));"_empty"==e||!d[m.p.id].viewPagerButtons?a("#pData,#nData",s+"_2").hide():a("#pData,#nData",s+"_2").show();a(m).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+p),F]);x&&x.call(m,a("#"+p));a("#"+a.jgrid.jqID(t.themodal)).data("onClose",
d[m.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,overlay:b.overlay,modal:b.modal});O||a(".jqmOverlay").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[m.p.id].onClose});return false});a(m).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+p),F]);z&&z.call(m,a("#"+p));a(".fm-button","#"+a.jgrid.jqID(t.themodal)).hover(function(){a(this).addClass("ui-state-hover")},
function(){a(this).removeClass("ui-state-hover")});a("#sData",s+"_2").click(function(){u={};a("#FormError",s).hide();f();if(u[m.p.id+"_id"]=="_empty")i();else if(b.checkOnSubmit===true)if(M=j(u,d[m.p.id]._savedData)){a("#"+p).data("disabled",true);a(".confirm","#"+a.jgrid.jqID(t.themodal)).show()}else i();else i();return false});a("#cData",s+"_2").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[m.p.id].onClose});
return false});a("#nData",s+"_2").click(function(){if(!k())return false;a("#FormError",s).hide();var c=o();c[0]=parseInt(c[0],10);if(c[0]!=-1&&c[1][c[0]+1]){a(m).triggerHandler("jqGridAddEditClickPgButtons",["next",a("#"+p),c[1][c[0]]]);var d;if(a.isFunction(b.onclickPgButtons)){d=b.onclickPgButtons.call(m,"next",a("#"+p),c[1][c[0]]);if(d!==void 0&&d===false)return false}if(a("#"+a.jgrid.jqID(c[1][c[0]+1])).hasClass("ui-state-disabled"))return false;h(c[1][c[0]+1],m,p);a(m).jqGrid("setSelection",
c[1][c[0]+1]);a(m).triggerHandler("jqGridAddEditAfterClickPgButtons",["next",a("#"+p),c[1][c[0]]]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(m,"next",a("#"+p),c[1][c[0]+1]);n(c[0]+1,c)}return false});a("#pData",s+"_2").click(function(){if(!k())return false;a("#FormError",s).hide();var c=o();if(c[0]!=-1&&c[1][c[0]-1]){a(m).triggerHandler("jqGridAddEditClickPgButtons",["prev",a("#"+p),c[1][c[0]]]);var d;if(a.isFunction(b.onclickPgButtons)){d=b.onclickPgButtons.call(m,"prev",a("#"+
p),c[1][c[0]]);if(d!==void 0&&d===false)return false}if(a("#"+a.jgrid.jqID(c[1][c[0]-1])).hasClass("ui-state-disabled"))return false;h(c[1][c[0]-1],m,p);a(m).jqGrid("setSelection",c[1][c[0]-1]);a(m).triggerHandler("jqGridAddEditAfterClickPgButtons",["prev",a("#"+p),c[1][c[0]]]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(m,"prev",a("#"+p),c[1][c[0]-1]);n(c[0]-1,c)}return false})}x=o();n(x[0],x)}})},viewGridRow:function(e,b){b=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",
height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,jqModal:!0,closeOnEscape:!1,labelswidth:"30%",closeicon:[],navkeys:[!1,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0},a.jgrid.view,b||{});d[a(this)[0].p.id]=b;return this.each(function(){function f(){(!0===d[j.p.id].closeOnEscape||!0===d[j.p.id].navkeys[0])&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(q.modalhead)).focus()},0)}function c(c,d,e,f){var g,h,i,j=0,k,l,m=[],
n=!1,o,p="<td class='CaptionTD form-view-label ui-widget-content' width='"+b.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",q="",t=["integer","number","currency"],s=0,r=0,x,v,z;for(o=1;o<=f;o++)q+=1==o?p:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:
!1;!h&&"right"===this.align&&(this.formatter&&-1!==a.inArray(this.formatter,t)?s=Math.max(s,parseInt(this.width,10)):r=Math.max(r,parseInt(this.width,10)))});x=0!==s?s:0!==r?r:0;n=a(d).jqGrid("getInd",c);a(d.p.colModel).each(function(b){g=this.name;v=!1;l=(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";z="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&z){k=!1===n?"":g==d.p.ExpandColumn&&!0===d.p.treeGrid?
a("td:eq("+b+")",d.rows[n]).text():a("td:eq("+b+")",d.rows[n]).html();v="right"===this.align&&0!==x?!0:!1;var c=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),o=parseInt(c.rowpos,10)||j+1,p=parseInt(2*(parseInt(c.colpos,10)||1),10);if(c.rowabove){var t=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+c.rowcontent+"</td></tr>");a(e).append(t);t[0].rp=o}i=a(e).find("tr[rowpos="+o+"]");0===i.length&&(i=a("<tr "+l+" rowpos='"+o+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(i).append(q),
a(e).append(i),i[0].rp=o);a("td:eq("+(p-2)+")",i[0]).html("<b>"+(void 0===c.label?d.p.colNames[b]:c.label)+"</b>");a("td:eq("+(p-1)+")",i[0]).append("<span>"+k+"</span>").attr("id","v_"+g);v&&a("td:eq("+(p-1)+") span",i[0]).css({"text-align":"right",width:x+"px"});m[j]=b;j++}});0<j&&(c=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+c+"'/></td></tr>"),c[0].rp=j+99,a(e).append(c));
return m}function h(b,c){var d,e,f=0,g,h;if(h=a(c).jqGrid("getInd",b,!0))a("td",h).each(function(b){d=c.p.colModel[b].name;e=c.p.colModel[b].editrules&&!0===c.p.colModel[b].editrules.edithidden?!1:!0===c.p.colModel[b].hidden?!0:!1;"cb"!==d&&"subgrid"!==d&&"rn"!==d&&(g=d==c.p.ExpandColumn&&!0===c.p.treeGrid?a(this).text():a(this).html(),a.extend({},c.p.colModel[b].editoptions||{}),d=a.jgrid.jqID("v_"+d),a("#"+d+" span","#"+n).html(g),e&&a("#"+d,"#"+n).parents("tr:first").hide(),f++)}),0<f&&a("#id_g",
"#"+n).val(b)}function g(b,c){var d=c[1].length-1;0===b?a("#pData","#"+n+"_2").addClass("ui-state-disabled"):void 0!==c[1][b-1]&&a("#"+a.jgrid.jqID(c[1][b-1])).hasClass("ui-state-disabled")?a("#pData",n+"_2").addClass("ui-state-disabled"):a("#pData","#"+n+"_2").removeClass("ui-state-disabled");b==d?a("#nData","#"+n+"_2").addClass("ui-state-disabled"):void 0!==c[1][b+1]&&a("#"+a.jgrid.jqID(c[1][b+1])).hasClass("ui-state-disabled")?a("#nData",n+"_2").addClass("ui-state-disabled"):a("#nData","#"+n+"_2").removeClass("ui-state-disabled")}
function i(){var b=a(j).jqGrid("getDataIDs"),c=a("#id_g","#"+n).val();return[a.inArray(c,b),b]}var j=this;if(j.grid&&e){var k=j.p.id,l="ViewGrid_"+a.jgrid.jqID(k),n="ViewTbl_"+a.jgrid.jqID(k),o="ViewGrid_"+k,m="ViewTbl_"+k,q={themodal:"viewmod"+k,modalhead:"viewhd"+k,modalcontent:"viewcnt"+k,scrollelm:l},p=a.isFunction(d[j.p.id].beforeInitData)?d[j.p.id].beforeInitData:!1,r=!0,s=1,t=0;if(void 0!==a("#"+a.jgrid.jqID(q.themodal))[0]){p&&(r=p.call(j,a("#"+l)),void 0===r&&(r=!0));if(!1===r)return;a(".ui-jqdialog-title",
"#"+a.jgrid.jqID(q.modalhead)).html(b.caption);a("#FormError","#"+n).hide();h(e,j);a.isFunction(d[j.p.id].beforeShowForm)&&d[j.p.id].beforeShowForm.call(j,a("#"+l));a.jgrid.viewModal("#"+a.jgrid.jqID(q.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,jqM:!1,overlay:b.overlay,modal:b.modal});f()}else{var x=isNaN(b.dataheight)?b.dataheight:b.dataheight+"px",z=isNaN(b.datawidth)?b.datawidth:b.datawidth+"px",o=a("<form name='FormPost' id='"+o+"' class='FormGrid' style='width:"+z+";overflow:auto;position:relative;height:"+
...
r="<a href='javascript:void(0)' id='"+(m?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";x="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bClose+"</a>";if(0<t){var H=[];a.each(a(v)[0].rows,function(a,b){H[a]=b});H.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(H,function(b,c){a("tbody",v).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(k);o=a("<div></div>").append(o).append("<table border='0' class='EditTable' id='"+
n+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+b.labelswidth+"'>"+(m?r+p:p+r)+"</td><td class='EditButton'>"+x+"</td></tr></tbody></table>");a.jgrid.createModal(q,o,b,"#gview_"+a.jgrid.jqID(j.p.id),a("#gview_"+a.jgrid.jqID(j.p.id))[0]);m&&(a("#pData, #nData","#"+n+"_2").css("float","right"),a(".EditButton","#"+n+"_2").css("text-align","left"));b.viewPagerButtons||a("#pData, #nData","#"+n+"_2").hide();o=null;a("#"+q.themodal).keydown(function(c){if(c.which===27){d[j.p.id].closeOnEscape&&
a.jgrid.hideModal("#"+a.jgrid.jqID(q.themodal),{gb:b.gbox,jqm:b.jqModal,onClose:b.onClose});return false}if(b.navkeys[0]===true){if(c.which===b.navkeys[1]){a("#pData","#"+n+"_2").trigger("click");return false}if(c.which===b.navkeys[2]){a("#nData","#"+n+"_2").trigger("click");return false}}});b.closeicon=a.extend([!0,"left","ui-icon-close"],b.closeicon);!0===b.closeicon[0]&&a("#cData","#"+n+"_2").addClass("right"==b.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+
b.closeicon[2]+"'></span>");a.isFunction(b.beforeShowForm)&&b.beforeShowForm.call(j,a("#"+l));a.jgrid.viewModal("#"+a.jgrid.jqID(q.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,overlay:b.overlay,modal:b.modal});a(".fm-button:not(.ui-state-disabled)","#"+n+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});f();a("#cData","#"+n+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(q.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,
onClose:b.onClose});return false});a("#nData","#"+n+"_2").click(function(){a("#FormError","#"+n).hide();var c=i();c[0]=parseInt(c[0],10);if(c[0]!=-1&&c[1][c[0]+1]){a.isFunction(b.onclickPgButtons)&&b.onclickPgButtons.call(j,"next",a("#"+l),c[1][c[0]]);h(c[1][c[0]+1],j);a(j).jqGrid("setSelection",c[1][c[0]+1]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(j,"next",a("#"+l),c[1][c[0]+1]);g(c[0]+1,c)}f();return false});a("#pData","#"+n+"_2").click(function(){a("#FormError","#"+n).hide();
var c=i();if(c[0]!=-1&&c[1][c[0]-1]){a.isFunction(b.onclickPgButtons)&&b.onclickPgButtons.call(j,"prev",a("#"+l),c[1][c[0]]);h(c[1][c[0]-1],j);a(j).jqGrid("setSelection",c[1][c[0]-1]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(j,"prev",a("#"+l),c[1][c[0]-1]);g(c[0]-1,c)}f();return false})}o=i();g(o[0],o)}})},delGridRow:function(e,b){b=a.extend(!0,{top:0,left:0,width:240,height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,url:"",mtype:"POST",reloadAfterSubmit:!0,
beforeShowForm:null,beforeInitData:null,afterShowForm:null,beforeSubmit:null,onclickSubmit:null,afterSubmit:null,jqModal:!0,closeOnEscape:!1,delData:{},delicon:[],cancelicon:[],onClose:null,ajaxDelOptions:{},processing:!1,serializeDelData:null,useDataProxy:!1},a.jgrid.del,b||{});d[a(this)[0].p.id]=b;return this.each(function(){var f=this;if(f.grid&&e){var c=a.isFunction(d[f.p.id].beforeShowForm),h=a.isFunction(d[f.p.id].afterShowForm),g=a.isFunction(d[f.p.id].beforeInitData)?d[f.p.id].beforeInitData:
!1,i=f.p.id,j={},k=!0,l="DelTbl_"+a.jgrid.jqID(i),n,o,m,q,p="DelTbl_"+i,r={themodal:"delmod"+i,modalhead:"delhd"+i,modalcontent:"delcnt"+i,scrollelm:l};a.isArray(e)&&(e=e.join());if(void 0!==a("#"+a.jgrid.jqID(r.themodal))[0]){g&&(k=g.call(f,a("#"+l)),void 0===k&&(k=!0));if(!1===k)return;a("#DelData>td","#"+l).text(e);a("#DelError","#"+l).hide();!0===d[f.p.id].processing&&(d[f.p.id].processing=!1,a("#dData","#"+l).removeClass("ui-state-active"));c&&d[f.p.id].beforeShowForm.call(f,a("#"+l));a.jgrid.viewModal("#"+
...
b||{});return this.each(function(){if(!this.nav){var j={themodal:"alertmod_"+this.p.id,modalhead:"alerthd_"+this.p.id,modalcontent:"alertcnt_"+this.p.id},k=this,l;if(k.grid&&"string"===typeof d){void 0===a("#"+j.themodal)[0]&&(!b.alerttop&&!b.alertleft&&(void 0!==window.innerWidth?(b.alertleft=window.innerWidth,b.alerttop=window.innerHeight):void 0!==document.documentElement&&void 0!==document.documentElement.clientWidth&&0!==document.documentElement.clientWidth?(b.alertleft=document.documentElement.clientWidth,
...
a.jgrid.jqID(k.p.id),a("#gbox_"+a.jgrid.jqID(k.p.id))[0],!0));var n=1,o,m=function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},q=function(){a(this).removeClass("ui-state-hover")};b.cloneToTop&&k.p.toppager&&(n=2);for(o=0;o<n;o++){var p=a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),r,s;0===o?(r=d,s=k.p.id,r==k.p.toppager&&(s+="_top",n=1)):(r=k.p.toppager,s=k.p.id+
"_top");"rtl"==k.p.direction&&a(p).attr("dir","rtl").css("float","right");b.add&&(c=c||{},l=a("<td class='ui-pg-button ui-corner-all'></td>"),a(l).append("<div class='ui-pg-div'><span class='ui-icon "+b.addicon+"'></span>"+b.addtext+"</div>"),a("tr",p).append(l),a(l,p).attr({title:b.addtitle||"",id:c.id||"add_"+s}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(b.addfunc)?b.addfunc.call(k):a(k).jqGrid("editGridRow","new",c));return false}).hover(m,q),l=null);b.edit&&(l=a("<td class='ui-pg-button ui-corner-all'></td>"),
f=f||{},a(l).append("<div class='ui-pg-div'><span class='ui-icon "+b.editicon+"'></span>"+b.edittext+"</div>"),a("tr",p).append(l),a(l,p).attr({title:b.edittitle||"",id:f.id||"edit_"+s}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c=k.p.selrow;if(c)a.isFunction(b.editfunc)?b.editfunc.call(k,c):a(k).jqGrid("editGridRow",c,f);else{a.jgrid.viewModal("#"+j.themodal,{gbox:"#gbox_"+a.jgrid.jqID(k.p.id),jqm:true});a("#jqg_alrt").focus()}}return false}).hover(m,q),l=null);b.view&&(l=a("<td class='ui-pg-button ui-corner-all'></td>"),
i=i||{},a(l).append("<div class='ui-pg-div'><span class='ui-icon "+b.viewicon+"'></span>"+b.viewtext+"</div>"),a("tr",p).append(l),a(l,p).attr({title:b.viewtitle||"",id:i.id||"view_"+s}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c=k.p.selrow;if(c)a.isFunction(b.viewfunc)?b.viewfunc.call(k,c):a(k).jqGrid("viewGridRow",c,i);else{a.jgrid.viewModal("#"+j.themodal,{gbox:"#gbox_"+a.jgrid.jqID(k.p.id),jqm:true});a("#jqg_alrt").focus()}}return false}).hover(m,q),l=null);b.del&&(l=a("<td class='ui-pg-button ui-corner-all'></td>"),
h=h||{},a(l).append("<div class='ui-pg-div'><span class='ui-icon "+b.delicon+"'></span>"+b.deltext+"</div>"),a("tr",p).append(l),a(l,p).attr({title:b.deltitle||"",id:h.id||"del_"+s}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c;if(k.p.multiselect){c=k.p.selarrrow;c.length===0&&(c=null)}else c=k.p.selrow;if(c)a.isFunction(b.delfunc)?b.delfunc.call(k,c):a(k).jqGrid("delGridRow",c,h);else{a.jgrid.viewModal("#"+j.themodal,{gbox:"#gbox_"+a.jgrid.jqID(k.p.id),jqm:true});a("#jqg_alrt").focus()}}return false}).hover(m,
q),l=null);(b.add||b.edit||b.del||b.view)&&a("tr",p).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");b.search&&(l=a("<td class='ui-pg-button ui-corner-all'></td>"),g=g||{},a(l).append("<div class='ui-pg-div'><span class='ui-icon "+b.searchicon+"'></span>"+b.searchtext+"</div>"),a("tr",p).append(l),a(l,p).attr({title:b.searchtitle||"",id:g.id||"search_"+s}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(b.searchfunc)?
b.searchfunc.call(k,g):a(k).jqGrid("searchGrid",g));return false}).hover(m,q),g.showOnLoad&&!0===g.showOnLoad&&a(l,p).click(),l=null);b.refresh&&(l=a("<td class='ui-pg-button ui-corner-all'></td>"),a(l).append("<div class='ui-pg-div'><span class='ui-icon "+b.refreshicon+"'></span>"+b.refreshtext+"</div>"),a("tr",p).append(l),a(l,p).attr({title:b.refreshtitle||"",id:"refresh_"+s}).click(function(){if(!a(this).hasClass("ui-state-disabled")){a.isFunction(b.beforeRefresh)&&b.beforeRefresh.call(k);k.p.search=
false;try{var c=k.p.id;k.p.postData.filters="";a("#fbox_"+a.jgrid.jqID(c)).jqFilter("resetFilter");a.isFunction(k.clearToolbar)&&k.clearToolbar.call(k,false)}catch(d){}switch(b.refreshstate){case "firstpage":a(k).trigger("reloadGrid",[{page:1}]);break;case "current":a(k).trigger("reloadGrid",[{current:true}])}a.isFunction(b.afterRefresh)&&b.afterRefresh.call(k)}return false}).hover(m,q),l=null);l=a(".ui-jqgrid").css("font-size")||"11px";a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+
l+";visibility:hidden;' ></div>");l=a(p).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(r+"_"+b.position,r).append(p);k.p._nvtd&&(l>k.p._nvtd[0]&&(a(r+"_"+b.position,r).width(l),k.p._nvtd[0]=l),k.p._nvtd[1]=l);p=l=l=null;this.nav=!0}}}})},navButtonAdd:function(d,b){b=a.extend({caption:"newButton",title:"",buttonicon:"ui-icon-newwin",onClickButton:null,position:"last",cursor:"pointer"},b||{});return this.each(function(){if(this.grid){"string"===typeof d&&0!==d.indexOf("#")&&(d="#"+a.jgrid.jqID(d));
...
colModel:j[i]},i)}catch(l){e=j[i].edittype&&"textarea"===j[i].edittype?a(this).text():a(this).html()}if("cb"!==c&&"subgrid"!==c&&"rn"!==c&&(b.p.autoencode&&(e=a.jgrid.htmlDecode(e)),h[c]=e,!0===j[i].editable)){null===g&&(g=i);k?a("span:first",this).html(""):a(this).html("");var s=a.extend({},j[i].editoptions||{},{id:d+"_"+c,name:c});j[i].edittype||(j[i].edittype="text");if("&nbsp;"===e||"&#160;"===e||1===e.length&&160===e.charCodeAt(0))e="";var w=a.jgrid.createEl.call(b,j[i].edittype,s,e,!0,a.extend({},
a.jgrid.ajaxOptions,b.p.ajaxSelectOptions||{}));a(w).addClass("editable");k?a("span:first",this).append(w):a(this).append(w);a.jgrid.bindEv(w,s,b);"select"===j[i].edittype&&void 0!==j[i].editoptions&&!0===j[i].editoptions.multiple&&void 0===j[i].editoptions.dataUrl&&a.jgrid.msie&&a(w).width(a(w).width());f++}}),0<f&&(h.id=d,b.p.savedRow.push(h),a(i).attr("editable","1"),a("td:eq("+g+") input",i).focus(),!0===k.keys&&a(i).bind("keydown",function(c){if(27===c.keyCode){a(b).jqGrid("restoreRow",d,k.afterrestorefunc);
...
a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===e?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}r=a.jgrid.checkValues(o[n],b,l);if(!1===r[0])return r[1]=o[n]+" "+r[1],!1;l.p.autoencode&&(o[n]=a.jgrid.htmlEncode(o[n]));"clientArray"!==j.url&&t.editoptions&&!0===t.editoptions.NullIfEmpty&&""===o[n]&&(q[n]="null")}});if(!1===r[0]){try{var x=a.jgrid.findPos(a("#"+
a.jgrid.jqID(d),l.grid.bDiv)[0]);a.jgrid.info_dialog(a.jgrid.errors.errcap,r[1],a.jgrid.edit.bClose,{left:x[0],top:x[1]})}catch(z){alert(r[1])}return k}var v=l.p.prmNames,x=d,i=!1===l.p.keyIndex?v.id:l.p.colModel[l.p.keyIndex+(!0===l.p.rownumbers?1:0)+(!0===l.p.multiselect?1:0)+(!0===l.p.subGrid?1:0)].name;if(o){o[v.oper]=v.editoper;if(void 0===o[i])o[i]=d;else if(s.id!==l.p.idPrefix+o[i]&&(v=a.jgrid.stripPref(l.p.idPrefix,d),void 0!==l.p._index[v]&&(l.p._index[o[i]]=l.p._index[v],delete l.p._index[v]),
d=l.p.idPrefix+o[i],a(s).attr("id",d),l.p.selrow===x&&(l.p.selrow=d),a.isArray(l.p.selarrrow)&&(v=a.inArray(x,l.p.selarrrow),0<=v&&(l.p.selarrrow[v]=d)),l.p.multiselect))v="jqg_"+l.p.id+"_"+d,a("input.cbox",s).attr("id",v).attr("name",v);void 0===l.p.inlineData&&(l.p.inlineData={});o=a.extend({},o,l.p.inlineData,j.extraparam)}if("clientArray"===j.url){o=a.extend({},o,m);l.p.autoencode&&a.each(o,function(b,c){o[b]=a.jgrid.htmlDecode(c)});v=a(l).jqGrid("setRowData",d,o);a(s).attr("editable","0");for(i=
0;i<l.p.savedRow.length;i++)if(""+l.p.savedRow[i].id===""+x){p=i;break}0<=p&&l.p.savedRow.splice(p,1);a(l).triggerHandler("jqGridInlineAfterSaveRow",[d,v,o,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(l,d,v,j);k=!0;a(s).removeClass("jqgrid-new-row").unbind("keydown")}else a("#lui_"+a.jgrid.jqID(l.p.id)).show(),q=a.extend({},o,q),q[i]=a.jgrid.stripPref(l.p.idPrefix,q[i]),a.ajax(a.extend({url:j.url,data:a.isFunction(l.p.serializeRowData)?l.p.serializeRowData.call(l,q):q,type:j.mtype,async:!1,
complete:function(b,c){a("#lui_"+a.jgrid.jqID(l.p.id)).hide();if("success"===c){var e=!0,f;f=a(l).triggerHandler("jqGridInlineSuccessSaveRow",[b,d,j]);a.isArray(f)||(f=[!0,o]);f[0]&&a.isFunction(j.successfunc)&&(f=j.successfunc.call(l,b));a.isArray(f)?(e=f[0],o=f[1]||o):e=f;if(!0===e){l.p.autoencode&&a.each(o,function(b,c){o[b]=a.jgrid.htmlDecode(c)});o=a.extend({},o,m);a(l).jqGrid("setRowData",d,o);a(s).attr("editable","0");for(e=0;e<l.p.savedRow.length;e++)if(""+l.p.savedRow[e].id===""+d){p=e;break}0<=
p&&l.p.savedRow.splice(p,1);a(l).triggerHandler("jqGridInlineAfterSaveRow",[d,b,o,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(l,d,b);k=!0;a(s).removeClass("jqgrid-new-row").unbind("keydown")}else a(l).triggerHandler("jqGridInlineErrorSaveRow",[d,b,c,null,j]),a.isFunction(j.errorfunc)&&j.errorfunc.call(l,d,b,c,null),!0===j.restoreAfterError&&a(l).jqGrid("restoreRow",d,j.afterrestorefunc)}},error:function(b,c,e){a("#lui_"+a.jgrid.jqID(l.p.id)).hide();a(l).triggerHandler("jqGridInlineErrorSaveRow",
[d,b,c,e,j]);if(a.isFunction(j.errorfunc))j.errorfunc.call(l,d,b,c,e);else{b=b.responseText||b.statusText;try{a.jgrid.info_dialog(a.jgrid.errors.errcap,'<div class="ui-state-error">'+b+"</div>",a.jgrid.edit.bClose,{buttonalign:"right"})}catch(f){alert(b)}}!0===j.restoreAfterError&&a(l).jqGrid("restoreRow",d,j.afterrestorefunc)}},a.jgrid.ajaxOptions,l.p.ajaxRowOptions||{}))}return k},restoreRow:function(d,e){var b=a.makeArray(arguments).slice(1),f={};"object"===a.type(b[0])?f=b[0]:a.isFunction(e)&&
...
h=b.p.treeReader.level_field,g=parseInt(d[f],10),i=parseInt(d[c],10),j=parseInt(d[h],10);a(this.p.data).each(function(){if(parseInt(this[h],10)===j-1&&parseInt(this[f],10)<g&&parseInt(this[c],10)>i)return e=this,!1});break;case "adjacency":var k=b.p.treeReader.parent_id_field,l=b.p.localReader.id;a(this.p.data).each(function(){if(this[l]===a.jgrid.stripPref(b.p.idPrefix,d[k]))return e=this,!1})}});return e},getNodeChildren:function(d){var e=[];this.each(function(){var b=this;if(b.grid&&b.p.treeGrid)switch(b.p.treeGridModel){case "nested":var f=
b.p.treeReader.left_field,c=b.p.treeReader.right_field,h=b.p.treeReader.level_field,g=parseInt(d[f],10),i=parseInt(d[c],10),j=parseInt(d[h],10);a(this.p.data).each(function(){parseInt(this[h],10)===j+1&&parseInt(this[f],10)>g&&parseInt(this[c],10)<i&&e.push(this)});break;case "adjacency":var k=b.p.treeReader.parent_id_field,l=b.p.localReader.id;a(this.p.data).each(function(){this[k]===a.jgrid.stripPref(b.p.idPrefix,d[l])&&e.push(this)})}});return e},getFullTreeNode:function(d){var e=[];this.each(function(){var b=
this,f;if(b.grid&&b.p.treeGrid)switch(b.p.treeGridModel){case "nested":var c=b.p.treeReader.left_field,h=b.p.treeReader.right_field,g=b.p.treeReader.level_field,i=parseInt(d[c],10),j=parseInt(d[h],10),k=parseInt(d[g],10);a(this.p.data).each(function(){parseInt(this[g],10)>=k&&parseInt(this[c],10)>=i&&parseInt(this[c],10)<=j&&e.push(this)});break;case "adjacency":if(d){e.push(d);var l=b.p.treeReader.parent_id_field,n=b.p.localReader.id;a(this.p.data).each(function(c){f=e.length;for(c=0;c<f;c++)if(a.jgrid.stripPref(b.p.idPrefix,
e[c][n])===this[l]){e.push(this);break}})}}});return e},getNodeAncestors:function(d){var e=[];this.each(function(){if(this.grid&&this.p.treeGrid)for(var b=a(this).jqGrid("getNodeParent",d);b;)e.push(b),b=a(this).jqGrid("getNodeParent",b)});return e},isVisibleNode:function(d){var e=!0;this.each(function(){if(this.grid&&this.p.treeGrid){var b=a(this).jqGrid("getNodeAncestors",d),f=this.p.treeReader.expanded_field;a(b).each(function(){e=e&&this[f];if(!e)return!1})}});return e},isNodeLoaded:function(d){var e;
...
this.p.localReader.id),j=a("#"+a.jgrid.jqID(i),this.grid.bDiv)[0],k=this.p._index[i];a(this).jqGrid("isNodeLoaded",this.p.data[k])?(d[e]=!0,a("div.treeclick",j).removeClass(this.p.treeIcons.plus+" tree-plus").addClass(this.p.treeIcons.minus+" tree-minus")):this.grid.hDiv.loading||(d[e]=!0,a("div.treeclick",j).removeClass(this.p.treeIcons.plus+" tree-plus").addClass(this.p.treeIcons.minus+" tree-minus"),this.p.treeANode=j.rowIndex,this.p.datatype=this.p.treedatatype,"nested"==this.p.treeGridModel?
...
k=c.p.treeReader.left_field,l=c.p.treeReader.right_field,n=c.p.treeReader.loaded,o,m,q,p,r;o=0;var s=e,t;void 0===f&&(f=!1);if(void 0===d||null===d){r=c.p.data.length-1;if(0<=r)for(;0<=r;)o=Math.max(o,parseInt(c.p.data[r][c.p.localReader.id],10)),r--;d=o+1}var x=a(c).jqGrid("getInd",e);t=!1;if(void 0===e||null===e||""===e)s=e=null,o="last",p=c.p.tree_root_level,r=c.p.data.length+1;else if(o="after",m=c.p._index[e],q=c.p.data[m],e=q[c.p.localReader.id],p=parseInt(q[i],10)+1,r=a(c).jqGrid("getFullTreeNode",
...
c.p.treeGridModel){var z;if(null!==e){g=parseInt(q[l],10);i=a.jgrid.from(c.p.data);i=i.greaterOrEquals(l,g,{stype:"integer"});i=i.select();if(i.length)for(z in i)i.hasOwnProperty(z)&&(i[z][k]=i[z][k]>g?parseInt(i[z][k],10)+2:i[z][k],i[z][l]=i[z][l]>=g?parseInt(i[z][l],10)+2:i[z][l]);b[k]=g;b[l]=g+1}else{g=parseInt(a(c).jqGrid("getCol",l,!1,"max"),10);i=a.jgrid.from(c.p.data).greater(k,g,{stype:"integer"}).select();if(i.length)for(z in i)i.hasOwnProperty(z)&&(i[z][k]=parseInt(i[z][k],10)+2);i=a.jgrid.from(c.p.data).greater(l,
g,{stype:"integer"}).select();if(i.length)for(z in i)i.hasOwnProperty(z)&&(i[z][l]=parseInt(i[z][l],10)+2);b[k]=g+1;b[l]=g+2}}if(null===e||a(c).jqGrid("isNodeLoaded",q)||t)a(c).jqGrid("addRowData",d,b,o,s),a(c).jqGrid("setTreeNode",r,m);q&&!q[h]&&f&&a(c.rows[x]).find("div.treeclick").click()}}})})(jQuery);
...
1===r.idx){var t=c.groups[p+1],x,z,v=void 0!==t?c.groups[p+1].startRow:d.length;for(z=r.startRow;z<v;z++)h+=d[z].join("");var H;if(void 0!==t){for(H=0;H<c.groupField.length&&t.dataIndex!==c.groupField[H];H++);m=c.groupField.length-H}for(t=0;t<m;t++)if(q[t]){z="";c.groupCollapse&&!c.showSummaryOnHide&&(z=' style="display:none;"');h+="<tr"+z+' jqfootlevel="'+(r.idx-t)+'" role="row" class="ui-widget-content jqfoot ui-row-'+f.p.direction+'">';z=b(p,t,c.groups);var w=f.p.colModel,B,G=z.cnt;for(x=0;x<e;x++){var u=
"<td "+f.formatCol(x,1,"")+">&#160;</td>",M="{0}";a.each(z.summary,function(){if(this.nm===w[x].name){w[x].summaryTpl&&(M=w[x].summaryTpl);"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&this.v&&0<G&&(this.v/=G);try{B=f.formatter("",this.v,x,this)}catch(b){B=this.v}u="<td "+f.formatCol(x,1,"")+">"+a.jgrid.format(M,B)+"</td>";return!1}});h+=u}h+="</tr>"}m=H}});a("#"+a.jgrid.jqID(f.p.id)+" tbody:first").append(h);h=null})},groupingGroupBy:function(d,e){return this.each(function(){"string"===
