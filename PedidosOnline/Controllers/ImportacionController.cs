...
namespace PedidosOnline.Controllers
{
    public class ImportacionController : Controller
    {
        ...
        ////            ObjContrato.IntermediarioID = int.Parse(form["intermediario"]);
        ////            ObjContrato.Seguro = bool.Parse(form["seguro"]);
        ////            ObjContrato.Calidad1 = form["calidad"];
        ////            ObjContrato.EmbarqueParcial = bool.Parse(form["periodoE"]);
        ////            ObjContrato.Transporte = form["transporte"];
        ////            ObjContrato.Calidad1 = form["calidad1"];
        ////            ObjContrato.Calidad2 = form["calidad2"];
        ////            ObjContrato.InspectorID = int.Parse(form["autoc_inspector"]);
